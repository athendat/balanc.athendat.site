"use strict";(self.webpackChunkfuse=self.webpackChunkfuse||[]).push([[3308],{30593:(A,y,a)=>{a.d(y,{$k:()=>b,BD:()=>e,DI:()=>l,E4:()=>h,ES:()=>d,F$:()=>_,FF:()=>E,N4:()=>r,Pn:()=>u,Q7:()=>m,RO:()=>T,XX:()=>g,Yv:()=>v,Zm:()=>i,_z:()=>n,eI:()=>S,hP:()=>c,ji:()=>f,l9:()=>P,qb:()=>$,s4:()=>t,tT:()=>p});var o=a(50967);const P=o.Ps`
...
`;var d=a(78501),T=a(30593),b=a(19212),E=a(84221);let c=(()=>{class h{constructor(t,e){this.apolloProvider=t,this.store=e,this._apollo=this.apolloProvider.use("BALANC")}getStocks(t=0,e=50,s="updatedAt",r="asc",u="",i="",$="",f=null){return this._apollo.query({query:v,errorPolicy:"all",variables:{page:t,size:e,sort:s,order:r,search:u,depotId:i,productId:$,availability:f}}).pipe((0,o.U)(({data:_})=>_?_.stocks:null),(0,P.b)(_=>{_&&(this.store.dispatch((0,n.Z4)({stocks:_.stocks})),this.store.dispatch((0,I.Jr)({pagination:_.pagination})))}))}findStockProducts(t="",e=10,s=null,r=null){return this._apollo.query({query:p,errorPolicy:"all",variables:{search:t,size:e,depotId:s,availability:r}}).pipe((0,o.U)(({data:u})=>u?u.findStockProducts.products:null),(0,P.b)(u=>{u&&this.store.dispatch((0,d.RU)({products:u}))}))}getProductsInStockAvailable(t="",e=50,s=null){return this._apollo.query({query:g,variables:{search:t,size:e,depotId:s},errorPolicy:"all"}).pipe((0,o.U)(({data:r})=>r?r.productsInStockAvailable:null),(0,P.b)(r=>{r&&this.store.dispatch((0,d.Pj)({productsInStock:r}))}))}getProductsInStockByDepot(t,e="",s=10){return this._apollo.query({query:T.s4,variables:{depotId:t,search:e,size:s},errorPolicy:"all"}).pipe((0,o.U)(({data:r})=>r?r.productsInStockByDepot:[]),(0,P.b)(r=>{r&&this.store.dispatch((0,d.Pj)({productsInStock:r}))}))}findStocks(t,e,s){return this._apollo.query({query:S,variables:{depotId:t,productId:e,availability:s},errorPolicy:"all"}).pipe((0,o.U)(({data:r})=>r?r.findStocks:[]))}static#t=this.\u0275fac=function(e){return new(e||h)(b.LFG(m._M),b.LFG(E.yh))};static#e=this.\u0275prov=b.Yz7({token:h,factory:h.\u0275fac,providedIn:"root"})}return h})()},62660:(A,y,a)=>{a.d(y,{Z:()=>m});var o=a(89711);const m=function n(v){return(0,o.Z)(v,5)}}}]);