"use strict";(self.webpackChunkfuse=self.webpackChunkfuse||[]).push([[6654],{99433:(U,S,s)=>{s.d(S,{w:()=>g});var f=s(17705),v=s(98300);const g=(d,y)=>(0,f.WQX)(v.d).getFuels()},56501:(U,S,s)=>{s.d(S,{UC:()=>d});var f=s(59640);const v=y=>y.fuels,d=((0,f.Mz)(v,y=>y.fuel),(0,f.Mz)(v,y=>y.fuels))},98300:(U,S,s)=>{s.d(S,{d:()=>x});var f=s(96697),v=s(25558),g=s(88141),d=s(31496),y=s(98216),C=s(56501),h=s(53473);const B=h.J1`
