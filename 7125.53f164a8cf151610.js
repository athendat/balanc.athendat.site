"use strict";(self.webpackChunkfuse=self.webpackChunkfuse||[]).push([[7125],{56808:(he,L,p)=>{p.d(L,{hQ:()=>D,wQ:()=>n});var R=p(59640);const e=v=>v.customers,D=(0,R.Mz)(e,v=>v.customer),n=(0,R.Mz)(e,v=>v.customers)},34413:(he,L,p)=>{p.d(L,{MI:()=>M,wf:()=>O,zA:()=>S});var R=p(54438),e=p(18810),D=p(99437),n=p(62590),v=p(51188);let O=(()=>{class x{constructor(m,_){this._employeesService=m,this._router=_}resolve(m,_){return this._employeesService.findAllEmployees().pipe((0,D.W)(y=>this._router.navigateByUrl("/desktop")))}static#e=this.\u0275fac=function(_){return new(_||x)(R.KVO(n.r),R.KVO(v.Ix))};static#t=this.\u0275prov=R.jDH({token:x,factory:x.\u0275fac,providedIn:"root"})}return x})(),S=(()=>{class x{constructor(m,_){this._employeesService=m,this._router=_}resolve(m,_){const y=m.params.employeeId;return"new"===y?null:this._employeesService.findEmployeeById(y).pipe((0,D.W)(b=>{const H=_.url.split("/").slice(0,-1).join("/");return this._router.navigateByUrl(H),(0,e.$)(b)}))}static#e=this.\u0275fac=function(_){return new(_||x)(R.KVO(n.r),R.KVO(v.Ix))};static#t=this.\u0275prov=R.jDH({token:x,factory:x.\u0275fac,providedIn:"root"})}return x})();const M=(x,Y)=>(0,R.WQX)(n.r).findActiveEmployees()},49098:(he,L,p)=>{p.d(L,{O:()=>H});var R=p(88141),e=p(96354),D=p(24984),n=p(98216),v=p(53473);const O=v.J1`
...
`;var y=p(54438),b=p(59640);let H=(()=>{class K{constructor(C,h){this.apolloProvider=C,this.store=h,this._apollo=this.apolloProvider.use("BALANC")}createLocation(C){return this._apollo.mutate({mutation:O,variables:{createLocationInput:C},errorPolicy:"all"}).pipe((0,R.M)(({data:h})=>{h&&(this.store.dispatch((0,D.yJ)({location:h.createLocation.location})),this.store.dispatch((0,D.Og)({location:h.createLocation.location})))}))}getLocations(C=0,h=25,G="name",u="asc",f=""){return this._apollo.query({query:Y,errorPolicy:"all",variables:{page:C,size:h,sort:G,order:u,search:f}}).pipe((0,R.M)(({data:I})=>{I&&(this.store.dispatch((0,n.Bp)({pagination:I.findAllLocations.pagination})),this.store.dispatch((0,D.xu)({locations:I.findAllLocations.locations})))}))}findActiveLocations(C="",h=25){return this._apollo.query({query:m,variables:{search:C,size:h},errorPolicy:"all"}).pipe((0,e.T)(({data:G})=>G?G.findActiveLocations:[]),(0,R.M)(G=>{G&&this.store.dispatch((0,D.xu)({locations:G}))}))}getLocationById(C){return this._apollo.query({query:_,variables:{findLocationByIdId:C},errorPolicy:"all"}).pipe((0,R.M)(({data:h})=>{h&&this.store.dispatch((0,D.Og)({location:h.findLocationById.location}))}))}updateLocation(C){return this._apollo.mutate({mutation:S,variables:{updateLocationInput:C},errorPolicy:"all"}).pipe((0,R.M)(({data:h})=>{h&&(this.store.dispatch((0,D.Nt)({location:h.updateLocation.location})),this.store.dispatch((0,D.Og)({location:h.updateLocation.location})))}))}updateLocationStatus(C){return this._apollo.mutate({mutation:M,variables:{updateEntityStatusInput:C},errorPolicy:"all"}).pipe((0,R.M)(({data:h})=>{h&&this.store.dispatch((0,D.jr)({id:C.id,active:C.active}))}))}removeLocation(C){return this._apollo.mutate({mutation:x,variables:{removeLocationId:C},errorPolicy:"all"}).pipe((0,R.M)(({data:h})=>{h&&this.store.dispatch((0,D.q$)({id:C}))}))}static#e=this.\u0275fac=function(h){return new(h||K)(y.KVO(v.Ic),y.KVO(b.il))};static#t=this.\u0275prov=y.jDH({token:K,factory:K.\u0275fac,providedIn:"root"})}return K})()},21112:(he,L,p)=>{p.r(L),p.d(L,{default:()=>is});var R=p(10729),e=p(54438);let D=(()=>{class r{static#e=this.\u0275fac=function(o){return new(o||r)};static#t=this.\u0275cmp=e.VBU({type:r,selectors:[["app-workshop"]],standalone:!0,features:[e.aNF],decls:1,vars:0,template:function(o,s){1&o&&e.nrm(0,"ath-content-menu")},dependencies:[R.k],encapsulation:2})}return r})();var n=p(89417),v=p(96695),O=p(30450),S=p(2042),M=p(7673),x=p(21413),Y=p(57786),m=p(56977),_=p(25558),y=p(96354),b=p(59640);const H=r=>r.workshops,Z=((0,b.Mz)(H,r=>r.workshop),(0,b.Mz)(H,r=>r.workshops));var C=p(47413),h=p(75351),G=p(67398),u=p(94794),f=p(32102),I=p(88834),E=p(96697),k=p(88141),$=p(67376),ee=p(36146),ie=p(98216),g=p(53473);const Be=g.J1`
...
`;var j=p(95416);let fe=(()=>{class r{constructor(t,o,s){this.apolloProvider=t,this._snackBar=o,this.store=s,this._apollo=this.apolloProvider.use("BALANC")}createWorkshop(t){return this.store.select(Z).pipe((0,E.s)(1),(0,_.n)(o=>this._apollo.mutate({mutation:Be,variables:{createWorkshopInput:t},errorPolicy:"all"}).pipe((0,k.M)(({data:s})=>{const i=(0,$.cloneDeep)(o);i.push(s.createWorkshop.workshop),this.store.dispatch((0,ee.ht)({workshops:i}))}))))}getWorkshops(t=1,o=20,s="code",i="asc",a=""){return this._apollo.query({query:Ye,errorPolicy:"all",variables:{offset:o*(t-1),limit:o,sort:s,order:i,search:a}}).pipe((0,k.M)(({data:l})=>{this.store.dispatch((0,ie.Bp)({pagination:l.findAllWorkshops.pagination})),this.store.dispatch((0,ee.ht)({workshops:l.findAllWorkshops.workshops}))}))}getWorkshopById(t){return this._apollo.query({query:Ue,variables:{findWorkshopByIdId:t},errorPolicy:"all"}).pipe((0,k.M)(({data:o})=>{this.store.dispatch((0,ee.if)({workshop:o.findWorkshopById.workshop}))}))}updateWorkshop(t){return this.store.select(Z).pipe((0,E.s)(1),(0,_.n)(o=>this._apollo.mutate({mutation:Ne,variables:{updateWorkshopInput:t},errorPolicy:"all"}).pipe((0,k.M)(({data:s})=>{const i=(0,$.cloneDeep)(o);i[o.findIndex(l=>l.id===t.id)]=s.updateWorkshop.workshop,this.store.dispatch((0,ee.ht)({workshops:i}))}))))}updateWorkshopStatus(t){return this.store.select(Z).pipe((0,E.s)(1),(0,_.n)(o=>this._apollo.mutate({mutation:ze,variables:{updateEntityStatusInput:t},errorPolicy:"all"}).pipe((0,k.M)(({})=>{const i=(0,$.cloneDeep)(o);i[o.findIndex(l=>l.id===t.id)].active=t.active,this.store.dispatch((0,ee.ht)({workshops:i}))}))))}removeWorkshop(t){return this.store.select(Z).pipe((0,E.s)(1),(0,_.n)(o=>this._apollo.mutate({mutation:Le,variables:{removeWorkshopId:t},errorPolicy:"all"}).pipe((0,k.M)(({})=>{const i=(0,$.cloneDeep)(o),a=o.findIndex(l=>l.id===t);i.splice(a,1),this.store.dispatch((0,ee.ht)({workshops:i}))}))))}static#e=this.\u0275fac=function(o){return new(o||r)(e.KVO(g.Ic),e.KVO(j.UG),e.KVO(b.il))};static#t=this.\u0275prov=e.jDH({token:r,factory:r.\u0275fac,providedIn:"root"})}return r})();var V=p(46601);function Xe(r,c){1&r&&(e.j41(0,"h2",2),e.EFF(1," Agregar Taller "),e.k0s())}function Je(r,c){1&r&&(e.j41(0,"h2",2),e.EFF(1," Editar Taller "),e.k0s())}function Qe(r,c){if(1&r&&(e.j41(0,"div",4)(1,"div",7)(2,"div",8)(3,"div",9)(4,"div",10)(5,"h6",11),e.EFF(6,"Nombre"),e.k0s(),e.j41(7,"span",12),e.EFF(8),e.k0s()()()()()()),2&r){const t=e.XpG();e.R7$(8),e.JRh(t.data.workshop.name||"Sin nombre")}}function qe(r,c){if(1&r&&(e.j41(0,"div",5)(1,"div",13)(2,"form",14)(3,"mat-form-field",15)(4,"mat-label"),e.EFF(5,"Nombre"),e.k0s(),e.nrm(6,"input",16),e.k0s()()()()),2&r){const t=e.XpG();e.R7$(2),e.Y8G("formGroup",t.workshopForm)("autocomplete","off"),e.R7$(4),e.Y8G("formControlName","name")("placeholder","Ejemplo: Taller de mec\xe1nica")}}function He(r,c){if(1&r){const t=e.RV6();e.j41(0,"button",19),e.bIt("click",function(){e.eBV(t);const s=e.XpG(2);return e.Njj(s.updateWorkshop())}),e.EFF(1," Actualizar "),e.k0s()}if(2&r){const t=e.XpG(2);e.Y8G("color","primary")("disabled",t.workshopForm.invalid)("matDialogClose","confirmed")}}function Ke(r,c){if(1&r){const t=e.RV6();e.j41(0,"button",19),e.bIt("click",function(){e.eBV(t);const s=e.XpG(2);return e.Njj(s.createWorkshop())}),e.EFF(1," Agregar "),e.k0s()}if(2&r){const t=e.XpG(2);e.Y8G("color","primary")("disabled",t.workshopForm.invalid)("matDialogClose","confirmed")}}function Ze(r,c){if(1&r&&(e.j41(0,"div",6)(1,"button",17),e.EFF(2," Cancelar "),e.k0s(),e.DNE(3,He,2,3,"button",18)(4,Ke,2,3,"button",18),e.k0s()),2&r){const t=e.XpG();e.R7$(),e.Y8G("matDialogClose","cancelled"),e.R7$(2),e.vxM(3,"edit"===t.data.dialogMode?3:-1),e.R7$(),e.vxM(4,"add"===t.data.dialogMode?4:-1)}}let et=(()=>{class r{constructor(t,o,s,i,a,l,d){this.data=t,this._workshopsService=o,this._changeDetectorRef=s,this._formBuilder=i,this._fuseConfirmationService=a,this._dialogRef=l,this._snackBar=d,this.dialogMode="view",this._unsubscribeAll=new x.B,this.dialogMode=t.dialogMode,this.workshop=t.workshop}ngOnInit(){this.workshopForm=this._formBuilder.group({id:new n.MJ(null),name:new n.MJ(null,[n.k0.maxLength(100)])}),"edit"===this.dialogMode&&this.workshopForm.patchValue(this.workshop)}ngOnDestroy(){this._unsubscribeAll.next(null),this._unsubscribeAll.complete()}closeDialog(){this._dialogRef.close()}createWorkshop(){let t=this.workshopForm.getRawValue();t=(0,G.A)(t,["id"]),this._fuseConfirmationService.open({title:"Crear taller",message:"\xbfEsta seguro que toda la informaci\xf3n es correcta?",icon:{show:!0,name:"mat_solid:question_mark",color:"info"},actions:{confirm:{label:"Aceptar",color:"primary"}}}).afterClosed().subscribe(s=>{"confirmed"===s&&this._workshopsService.createWorkshop(t).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(({data:i})=>{this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:5e3,data:{message:i.createWorkshop.message,title:"Confirmaci\xf3n",type:"success",svgIcon:"mat_solid:done"}})}),this._changeDetectorRef.markForCheck()})}updateWorkshop(){const t=this.workshopForm.getRawValue();this._fuseConfirmationService.open({title:"Actualizar taller",message:"\xbfEsta seguro que toda la informaci\xf3n es correcta?",icon:{show:!0,name:"mat_solid:question_mark",color:"info"},actions:{confirm:{label:"Aceptar",color:"primary"}}}).afterClosed().subscribe(s=>{"confirmed"===s&&this._workshopsService.updateWorkshop(t).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(({data:i})=>{this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:5e3,data:{message:i.updateWorkshop.message,title:"Confirmaci\xf3n",type:"success",svgIcon:"mat_solid:done"}})}),this._changeDetectorRef.markForCheck()})}static#e=this.\u0275fac=function(o){return new(o||r)(e.rXU(h.Vh),e.rXU(fe),e.rXU(e.gRc),e.rXU(n.ok),e.rXU(V.G),e.rXU(h.CP),e.rXU(j.UG))};static#t=this.\u0275cmp=e.VBU({type:r,selectors:[["lists-workshop-dialog"]],standalone:!0,features:[e.aNF],decls:8,vars:5,consts:[[1,"relative","flex","flex-col","w-full","max-h-screenl"],[1,"flex","flex-col","items-center","px-8","pt-4","space-y-1","text-center","sm:items-start","sm:mt-0","sm:pr-8","sm:text-left"],[1,"text-2xl","text-gray-400"],[1,"flex","flex-col","items-center","flex-auto","w-full","px-8","pb-6","sm:flex-row","sm:items-start","sm:pb-8"],[1,"flex-auto"],[1,"w-full","overflow-hidden"],[1,"flex","items-center","justify-center","px-6","py-4","space-x-3","sm:justify-end","bg-gray-50","dark:bg-black/10"],[1,"flex"],[1,"flex","flex-col","w-full","mt-5"],[1,"flex","flex-col","p-8","pb-0","sm:flex-row"],[1,"w-full","py-10","my-10"],[1,"mb-2","font-medium"],[1,"border-sm"],[1,"flex","flex-col"],[1,"flex","flex-col","w-full","gap-5","mt-3",3,"formGroup","autocomplete"],[1,"w-full","fuse-mat-no-subscript"],["matInput","","type","text","required","","maxlength","50",3,"formControlName","placeholder"],["mat-stroked-button","",3,"matDialogClose"],["mat-flat-button","",3,"color","disabled","matDialogClose"],["mat-flat-button","",3,"click","color","disabled","matDialogClose"]],template:function(o,s){1&o&&(e.j41(0,"div",0)(1,"div",1),e.DNE(2,Xe,2,0,"h2",2)(3,Je,2,0,"h2",2),e.k0s(),e.j41(4,"div",3),e.DNE(5,Qe,9,1,"div",4)(6,qe,7,4,"div",5),e.k0s(),e.DNE(7,Ze,5,3,"div",6),e.k0s()),2&o&&(e.R7$(2),e.vxM(2,"add"===s.data.dialogMode?2:-1),e.R7$(),e.vxM(3,"edit"===s.data.dialogMode?3:-1),e.R7$(2),e.vxM(5,"view"===s.data.dialogMode?5:-1),e.R7$(),e.vxM(6,6),e.R7$(),e.vxM(7,"view"!==s.data.dialogMode?7:-1))},dependencies:[h.hM,h.tx,n.X1,n.qT,n.me,n.BC,n.cb,n.YS,n.tU,n.j4,n.JD,f.RG,f.rl,f.nJ,I.Hl,I.$z],encapsulation:2})}return r})();class tt{}var W=p(99213),U=p(59042),w=p(60177),J=p(9183);const ot=r=>({"pointer-events-none":r}),rt=()=>[5,10,25,100];function st(r,c){if(1&r){const t=e.RV6();e.j41(0,"mat-slide-toggle",29),e.bIt("change",function(s){e.eBV(t);const i=e.XpG(),a=i.$implicit,l=i.$index,d=e.XpG(4);return e.Njj(d.updateWorkshopStatus(s,a,l))}),e.k0s()}if(2&r){const t=e.XpG().$implicit;e.Y8G("checked",t.active)("color","primary")}}function it(r,c){1&r&&e.nrm(0,"mat-spinner",25),2&r&&e.Y8G("diameter",20)("color","primary")}function nt(r,c){if(1&r){const t=e.RV6();e.j41(0,"div",22)(1,"div",18),e.EFF(2),e.k0s(),e.j41(3,"div",23),e.EFF(4),e.k0s(),e.j41(5,"div",20),e.DNE(6,st,1,2,"mat-slide-toggle",24)(7,it,1,2,"mat-spinner",25),e.k0s(),e.j41(8,"div",26)(9,"button",27),e.bIt("click",function(){const s=e.eBV(t).$implicit,i=e.XpG(4);return e.Njj(i.openDialog(s,"edit"))}),e.nrm(10,"mat-icon",28),e.k0s(),e.j41(11,"button",27),e.bIt("click",function(){const s=e.eBV(t).$implicit,i=e.XpG(4);return e.Njj(i.deleteWorkshop(s))}),e.nrm(12,"mat-icon",28),e.k0s()()()}if(2&r){const t=c.$implicit,o=c.$index,s=e.XpG(4);e.R7$(2),e.SpI(" ",o+1," "),e.R7$(2),e.SpI(" ",t.name," "),e.R7$(2),e.vxM(6,s.isSlideLoading&&s.selectedSlide===o?-1:6),e.R7$(),e.vxM(7,s.isSlideLoading&&s.selectedSlide===o?7:-1),e.R7$(3),e.Y8G("svgIcon","mat_solid:edit"),e.R7$(2),e.Y8G("svgIcon","mat_solid:delete")}}function at(r,c){1&r&&e.Z7z(0,nt,13,6,"div",22,e.BUC().trackByFn,!0),2&r&&e.Dyx(c)}function ct(r,c){if(1&r&&(e.j41(0,"div",16)(1,"div",17),e.nrm(2,"div",18),e.j41(3,"div",19),e.EFF(4," Nombre "),e.k0s(),e.j41(5,"div",20),e.EFF(6," Activo "),e.k0s(),e.j41(7,"div",20),e.EFF(8," Acciones "),e.k0s()(),e.DNE(9,at,2,0),e.nI1(10,"async"),e.nrm(11,"mat-paginator",21),e.k0s()),2&r){let t;const o=e.XpG(2);e.R7$(3),e.Y8G("mat-sort-header","name"),e.R7$(6),e.vxM(9,(t=e.bMT(10,8,o.workshops$))?9:-1,t),e.R7$(2),e.Y8G("ngClass",e.eq3(10,ot,o.isLoading))("length",o.pagination.length)("pageIndex",o.pagination.page)("pageSize",o.pagination.size)("pageSizeOptions",e.lJ4(12,rt))("showFirstLastButtons",!0)}}function lt(r,c){1&r&&(e.j41(0,"div",30),e.EFF(1," \xa1No hay talleres creados para el negocio!"),e.k0s())}function pt(r,c){1&r&&e.DNE(0,ct,12,13,"div",16)(1,lt,2,0),2&r&&e.vxM(0,c.length>0?0:1)}let dt=(()=>{class r{constructor(t,o,s,i,a,l){this._workshopsService=t,this._changeDetectorRef=o,this._dialog=s,this._fuseConfirmationService=i,this._snackBar=a,this.store=l,this.workshop=new tt,this.workshops$=(0,M.of)([]),this.isLoading=!1,this.isSlideLoading=!1,this.searchInputControl=new n.MJ,this.selectedSlide=null,this._unsubscribeAll=new x.B}ngOnInit(){this.workshops$=this.store.select(Z),this.store.select(C.Dz).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(t=>{this.pagination=t,this._changeDetectorRef.markForCheck()})}ngAfterViewInit(){this._sort&&this._paginator&&(this._sort.sort({id:"code",start:"asc",disableClear:!0}),this._changeDetectorRef.markForCheck(),this._sort.sortChange.pipe((0,m.Q)(this._unsubscribeAll)).subscribe(()=>{this._paginator.pageIndex=0}),(0,Y.h)(this._sort.sortChange,this._paginator.page).pipe((0,_.n)(()=>(this.isLoading=!0,this._workshopsService.getWorkshops(this._paginator.pageIndex+1,this._paginator.pageSize,this._sort.active,this._sort.direction,this.searchInputControl.value))),(0,y.T)(()=>{this.isLoading=!1})).subscribe())}ngOnDestroy(){this._unsubscribeAll.next(null),this._unsubscribeAll.complete()}deleteWorkshop(t){this._fuseConfirmationService.open({title:"Cuidado",message:`\xbfEst\xe1 seguro que desea eliminar la taller: ${t.name}?`,icon:{show:!0,name:"mat_solid:question_mark",color:"warning"},actions:{confirm:{label:"Aceptar",color:"primary"}}}).afterClosed().pipe((0,m.Q)(this._unsubscribeAll)).subscribe(s=>{"confirmed"===s&&this._workshopsService.removeWorkshop(t.id).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(({data:i})=>{this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:5e3,data:{message:i.removeWorkshop.message,title:"Confirmaci\xf3n",type:"success",svgIcon:"mat_solid:done"}}),this._changeDetectorRef.markForCheck()})})}updateWorkshopStatus(t,o,s){this.isSlideLoading=!0,this.selectedSlide=s,this._workshopsService.updateWorkshopStatus({id:o.id,active:t.checked}).subscribe(({data:i})=>{this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:5e3,data:{message:i.updateWorkshopStatus.message,title:"Confirmaci\xf3n",type:"success",svgIcon:"mat_solid:done"}}),this.isSlideLoading=!1,this.selectedSlide=null,this._changeDetectorRef.markForCheck()})}trackByFn(t,o){return o.id||t}openDialog(t,o){this._dialog.open(et,{data:{workshop:t,dialogMode:o},panelClass:"ath-dialog-panel"})}static#e=this.\u0275fac=function(o){return new(o||r)(e.rXU(fe),e.rXU(e.gRc),e.rXU(h.bZ),e.rXU(V.G),e.rXU(j.UG),e.rXU(b.il))};static#t=this.\u0275cmp=e.VBU({type:r,selectors:[["workshop-workshops"]],viewQuery:function(o,s){if(1&o&&(e.GBs(v.iy,5),e.GBs(S.B4,5)),2&o){let i;e.mGM(i=e.lsd())&&(s._paginator=i.first),e.mGM(i=e.lsd())&&(s._sort=i.first)}},standalone:!0,features:[e.aNF],decls:27,vars:6,consts:[[1,"flex","flex-col","flex-auto","min-w-0","sm:absolute","sm:inset-0","sm:overflow-hidden","bg-card","dark:bg-transparent"],[1,"relative","flex","flex-col","px-6","py-8","border-b","sm:flex-row","flex-0","sm:items-center","sm:justify-between","md:px-8"],[1,"flex-1","min-w-0"],[1,"flex","flex-wrap","items-center","font-medium"],["routerLink","/desktop",1,"whitespace-nowrap","text-primary-500"],[1,"flex","items-center","ml-1","whitespace-nowrap"],[1,"icon-size-5","text-secondary",3,"svgIcon"],[1,"ml-1","text-primary-500"],[1,"mt-2"],[1,"text-3xl","font-extrabold","leading-7","tracking-tight","truncate","sm:leading-10"],[1,"flex","items-center","gap-2","mt-6","shrink-0","sm:mt-0","sm:ml-4"],["mat-raised-button","",1,"text-white","bg-gradient-to-r","from-primary-500","to-primary-700",3,"click"],[3,"svgIcon"],[1,"hidden","ml-2","mr-1","text-white","sm:block"],[1,"flex","flex-auto","overflow-hidden"],[1,"flex","flex-col","flex-auto","overflow-hidden","sm:mb-18","sm:overflow-y-auto"],[1,"grid"],["matSort","","matSortDisableClear","",1,"sticky","top-0","z-10","grid","gap-4","px-6","py-4","overflow-x-auto","font-semibold","shadow","lists-grid","md:px-8","text-md","text-secondary","bg-gray-50","dark:bg-slate-900"],[1,"hidden","sm:block"],[3,"mat-sort-header"],[1,"text-center"],[1,"z-10","border-b","sm:absolute","sm:inset-x-0","sm:bottom-0","sm:border-t","sm:border-b-0","bg-gray-50","dark:bg-transparent",3,"ngClass","length","pageIndex","pageSize","pageSizeOptions","showFirstLastButtons"],[1,"grid","items-center","gap-4","px-6","py-3","overflow-auto","border-b","lists-grid","md:px-8"],[1,"truncate"],[3,"checked","color"],[3,"diameter","color"],[1,"flex","flex-col","items-center","justify-center","gap-1","md:flex-row"],["mat-stroked-button","",1,"px-2","leading-6","min-w-10","min-h-7","h-7",3,"click"],[1,"icon-size-5",3,"svgIcon"],[3,"change","checked","color"],[1,"p-8","text-4xl","font-semibold","tracking-tight","text-center","border-t","sm:p-16"]],template:function(o,s){if(1&o&&(e.j41(0,"div",0)(1,"div",1)(2,"div",2)(3,"div",3)(4,"div")(5,"a",4),e.EFF(6,"Inicio"),e.k0s()(),e.j41(7,"div",5),e.nrm(8,"mat-icon",6),e.j41(9,"a",7),e.EFF(10,"Taller"),e.k0s()(),e.j41(11,"div",5),e.nrm(12,"mat-icon",6),e.j41(13,"a",7),e.EFF(14,"Talleres"),e.k0s()()(),e.j41(15,"div",8)(16,"h2",9),e.EFF(17," Talleres "),e.k0s()()(),e.j41(18,"div",10)(19,"button",11),e.bIt("click",function(){return s.openDialog(s.workshop,"add")}),e.nrm(20,"mat-icon",12),e.j41(21,"span",13),e.EFF(22,"Agregar"),e.k0s()()()(),e.j41(23,"div",14)(24,"div",15),e.DNE(25,pt,2,1),e.nI1(26,"async"),e.k0s()()()),2&o){let i;e.R7$(8),e.Y8G("svgIcon","mat_solid:chevron_right"),e.R7$(4),e.Y8G("svgIcon","mat_solid:chevron_right"),e.R7$(8),e.Y8G("svgIcon","mat_solid:add"),e.R7$(5),e.vxM(25,(i=e.bMT(26,4,s.workshops$))?25:-1,i)}},dependencies:[w.Jj,I.Hl,I.$z,f.RG,W.m_,W.An,U.fS,v.Ou,v.iy,J.D6,J.LG,O.mV,O.sG,S.NQ,S.B4,S.aE,w.YU,n.X1],encapsulation:2,changeDetection:0})}return r})();var A=p(51188);const Fe=r=>r.vehicles,mt=(0,b.Mz)(Fe,r=>r.vehicle),te=(0,b.Mz)(Fe,r=>r.vehicles);class xe{}var ne=p(91062);const ut=g.J1`
...
`;let me=(()=>{class r{constructor(t,o,s){this.apolloProvider=t,this._snackBar=o,this.store=s,this._apollo=this.apolloProvider.use("BALANC")}createVehicle(t){return this.store.select(te).pipe((0,E.s)(1),(0,_.n)(o=>this._apollo.mutate({mutation:ut,variables:{createVehicleInput:t},errorPolicy:"all"}).pipe((0,k.M)(({errors:s,data:i})=>{if(s){let l="";s.forEach(d=>l+=`\n ${d.message}.`),this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:l,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}const a=(0,$.cloneDeep)(o);a.push(i.createVehicle.vehicle),this.store.dispatch((0,ne._v)({vehicles:a}))}))))}getVehicles(t=1,o=20,s="code",i="asc",a=""){return this._apollo.query({query:_t,errorPolicy:"all",variables:{offset:o*(t-1),limit:o,sort:s,order:i,search:a}}).pipe((0,k.M)(({errors:l,data:d})=>{if(l){let F="";l.forEach(q=>F+=`\n ${q.message}.`),this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:F,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}this.store.dispatch((0,ie.Bp)({pagination:d.findAllVehicles.pagination})),this.store.dispatch((0,ne._v)({vehicles:d.findAllVehicles.vehicles}))}))}getVehicleById(t){return this._apollo.query({query:gt,variables:{findVehicleByIdId:t},errorPolicy:"all"}).pipe((0,k.M)(({errors:o,data:s})=>{if(o){let i="";o.forEach(a=>i+=`\n ${a.message}.`),this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:i,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}this.store.dispatch((0,ne.R8)({vehicle:s.findVehicleById.vehicle}))}))}updateVehicle(t){return this.store.select(te).pipe((0,E.s)(1),(0,_.n)(o=>this._apollo.mutate({mutation:ht,variables:{updateVehicleInput:t},errorPolicy:"all"}).pipe((0,k.M)(({errors:s,data:i})=>{if(s){let d="";s.forEach(F=>d+=`\n ${F.message}.`),this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:d,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}const a=(0,$.cloneDeep)(o);a[o.findIndex(d=>d.id===t.id)]=i.updateVehicle.vehicle,this.store.dispatch((0,ne._v)({vehicles:a}))}))))}removeVehicle(t){return this.store.select(te).pipe((0,E.s)(1),(0,_.n)(o=>this._apollo.mutate({mutation:ft,variables:{removeVehicleId:t},errorPolicy:"all"}).pipe((0,k.M)(({errors:s})=>{if(s){let l="";s.forEach(d=>l+=`\n ${d.message}.`),this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:l,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}const i=(0,$.cloneDeep)(o),a=o.findIndex(l=>l.id===t);i.splice(a,1),this.store.dispatch((0,ne._v)({vehicles:i}))}))))}static#e=this.\u0275fac=function(o){return new(o||r)(e.KVO(g.Ic),e.KVO(j.UG),e.KVO(b.il))};static#t=this.\u0275prov=e.jDH({token:r,factory:r.\u0275fac,providedIn:"root"})}return r})();const vt=()=>["new"],kt=r=>({"pointer-events-none":r}),bt=()=>[5,10,25,100],Ft=r=>[r];function xt(r,c){if(1&r){const t=e.RV6();e.j41(0,"div",25)(1,"div",21),e.EFF(2),e.k0s(),e.j41(3,"div",26),e.EFF(4),e.k0s(),e.j41(5,"div",23),e.EFF(6),e.k0s(),e.j41(7,"div",23),e.EFF(8),e.k0s(),e.j41(9,"div",23),e.EFF(10),e.k0s(),e.j41(11,"div",27)(12,"button",28),e.nrm(13,"mat-icon",29),e.k0s(),e.j41(14,"button",30),e.bIt("click",function(){const s=e.eBV(t).$implicit,i=e.XpG(4);return e.Njj(i.deleteVehicle(s))}),e.nrm(15,"mat-icon",29),e.k0s()()()}if(2&r){const t=c.$implicit,o=c.$index;e.R7$(2),e.SpI(" ",o+1," "),e.R7$(2),e.SpI(" ",t.registrationNumber," "),e.R7$(2),e.SpI(" ",t.customer.name," "),e.R7$(2),e.SpI(" ",t.brand.name," "),e.R7$(2),e.SpI(" ",t.fuel.name," "),e.R7$(2),e.Y8G("routerLink",e.eq3(8,Ft,t.id)),e.R7$(),e.Y8G("svgIcon","mat_solid:edit"),e.R7$(2),e.Y8G("svgIcon","mat_solid:delete")}}function It(r,c){1&r&&e.Z7z(0,xt,16,10,"div",25,e.BUC().trackByFn,!0),2&r&&e.Dyx(c)}function Ct(r,c){if(1&r&&(e.j41(0,"div",19)(1,"div",20),e.nrm(2,"div",21),e.j41(3,"div",22),e.EFF(4," Chapa "),e.k0s(),e.j41(5,"div",23),e.EFF(6," Cliente "),e.k0s(),e.j41(7,"div",23),e.EFF(8," Marca "),e.k0s(),e.j41(9,"div",23),e.EFF(10," Combustible "),e.k0s(),e.j41(11,"div",23),e.EFF(12," Acciones "),e.k0s()(),e.DNE(13,It,2,0),e.nI1(14,"async"),e.nrm(15,"mat-paginator",24),e.k0s()),2&r){let t;const o=e.XpG(2);e.R7$(3),e.Y8G("mat-sort-header","registrationNumber"),e.R7$(10),e.vxM(13,(t=e.bMT(14,8,o.vehicles$))?13:-1,t),e.R7$(2),e.Y8G("ngClass",e.eq3(10,kt,o.isLoading))("length",o.pagination.length)("pageIndex",o.pagination.page)("pageSize",o.pagination.size)("pageSizeOptions",e.lJ4(12,bt))("showFirstLastButtons",!0)}}function yt(r,c){1&r&&(e.j41(0,"div",31),e.EFF(1," \xa1No hay veh\xedculos de clientes registrados!"),e.k0s())}function St(r,c){1&r&&e.DNE(0,Ct,16,13,"div",19)(1,yt,2,0),2&r&&e.vxM(0,c.length>0?0:1)}let Et=(()=>{class r{constructor(t,o,s,i,a,l){this._vehiclesService=t,this._changeDetectorRef=o,this._dialog=s,this._fuseConfirmationService=i,this._snackBar=a,this.store=l,this.vehicle=new xe,this.vehicles$=(0,M.of)([]),this.isLoading=!1,this.isSlideLoading=!1,this.searchInputControl=new n.MJ,this.selectedSlide=null,this._unsubscribeAll=new x.B}ngOnInit(){this.vehicles$=this.store.select(te),this.store.select(C.Dz).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(t=>{this.pagination=t,this._changeDetectorRef.markForCheck()})}ngAfterViewInit(){this._sort&&this._paginator&&(this._sort.sort({id:"code",start:"asc",disableClear:!0}),this._changeDetectorRef.markForCheck(),this._sort.sortChange.pipe((0,m.Q)(this._unsubscribeAll)).subscribe(()=>{this._paginator.pageIndex=0}),(0,Y.h)(this._sort.sortChange,this._paginator.page).pipe((0,_.n)(()=>(this.isLoading=!0,this._vehiclesService.getVehicles(this._paginator.pageIndex+1,this._paginator.pageSize,this._sort.active,this._sort.direction,this.searchInputControl.value))),(0,y.T)(()=>{this.isLoading=!1})).subscribe())}ngOnDestroy(){this._unsubscribeAll.next(null),this._unsubscribeAll.complete()}deleteVehicle(t){this._fuseConfirmationService.open({title:"Cuidado",message:`\xbfEst\xe1 seguro que desea eliminar la taller: ${t.registrationNumber}?`,icon:{show:!0,name:"mat_solid:question_mark",color:"warning"},actions:{confirm:{label:"Aceptar",color:"primary"}}}).afterClosed().pipe((0,m.Q)(this._unsubscribeAll)).subscribe(s=>{"confirmed"===s&&this._vehiclesService.removeVehicle(t.id).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(({data:i})=>{this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:5e3,data:{message:i.removeVehicle.message,title:"Confirmaci\xf3n",type:"success",svgIcon:"mat_solid:done"}}),this._changeDetectorRef.markForCheck()})})}trackByFn(t,o){return o.id||t}static#e=this.\u0275fac=function(o){return new(o||r)(e.rXU(me),e.rXU(e.gRc),e.rXU(h.bZ),e.rXU(V.G),e.rXU(j.UG),e.rXU(b.il))};static#t=this.\u0275cmp=e.VBU({type:r,selectors:[["vehicle-vehicles"]],viewQuery:function(o,s){if(1&o&&(e.GBs(v.iy,5),e.GBs(S.B4,5)),2&o){let i;e.mGM(i=e.lsd())&&(s._paginator=i.first),e.mGM(i=e.lsd())&&(s._sort=i.first)}},standalone:!0,features:[e.aNF],decls:30,vars:12,consts:[["cdkScrollable","",1,"flex","flex-col","flex-auto","min-w-0","sm:absolute","sm:inset-0","sm:overflow-hidden","bg-card","dark:bg-transparent"],[1,"relative","flex","flex-col","px-6","py-8","border-b","sm:flex-row","flex-0","sm:items-center","sm:justify-between","md:px-8"],[1,"flex-1","min-w-0"],[1,"flex","flex-wrap","items-center","font-medium"],["routerLink","/desktop",1,"whitespace-nowrap","text-primary-500"],[1,"flex","items-center","ml-1","whitespace-nowrap"],[1,"icon-size-5","text-secondary",3,"svgIcon"],[1,"ml-1","text-primary-500"],[1,"mt-2"],[1,"text-3xl","font-extrabold","leading-7","tracking-tight","truncate","sm:leading-10"],[1,"flex","items-center","mt-6","shrink-0","sm:mt-0","sm:ml-4","gap-2"],[1,"fuse-mat-dense","fuse-mat-rounded","min-w-64"],["matPrefix","",1,"icon-size-5",3,"svgIcon"],["matInput","",3,"formControl","autocomplete","placeholder"],["mat-raised-button","",1,"text-white","bg-gradient-to-r","from-primary-500","to-primary-700",3,"routerLink"],[3,"svgIcon"],[1,"hidden","ml-2","mr-1","text-white","sm:block"],[1,"flex","flex-auto","overflow-hidden"],[1,"flex","flex-col","flex-auto","sm:mb-18","overflow-auto"],[1,"grid"],["matSort","","matSortDisableClear","",1,"sticky","top-0","z-10","grid","gap-4","px-6","py-4","font-semibold","shadow","vehicles-grid","md:px-8","text-md","text-secondary","bg-gray-50","dark:bg-slate-900"],[1,"hidden","sm:block"],[3,"mat-sort-header"],[1,"text-center"],[1,"z-10","border-b","sm:absolute","sm:inset-x-0","sm:bottom-0","sm:border-t","sm:border-b-0","bg-gray-50","dark:bg-transparent",3,"ngClass","length","pageIndex","pageSize","pageSizeOptions","showFirstLastButtons"],[1,"grid","items-center","gap-4","px-6","py-3","border-b","vehicles-grid","md:px-8"],[1,"truncate"],[1,"flex","flex-col","items-center","justify-center","gap-1","md:flex-row"],["mat-stroked-button","",1,"px-2","leading-6","min-w-10","min-h-7","h-7",3,"routerLink"],[1,"icon-size-5",3,"svgIcon"],["mat-stroked-button","",1,"px-2","leading-6","min-w-10","min-h-7","h-7",3,"click"],[1,"p-8","text-4xl","font-semibold","tracking-tight","text-center","border-t","sm:p-16"]],template:function(o,s){if(1&o&&(e.j41(0,"div",0)(1,"div",1)(2,"div",2)(3,"div",3)(4,"div")(5,"a",4),e.EFF(6,"Inicio"),e.k0s()(),e.j41(7,"div",5),e.nrm(8,"mat-icon",6),e.j41(9,"a",7),e.EFF(10,"Taller"),e.k0s()(),e.j41(11,"div",5),e.nrm(12,"mat-icon",6),e.j41(13,"a",7),e.EFF(14,"Veh\xedculos"),e.k0s()()(),e.j41(15,"div",8)(16,"h2",9),e.EFF(17," Veh\xedculos "),e.k0s()()(),e.j41(18,"div",10)(19,"mat-form-field",11),e.nrm(20,"mat-icon",12)(21,"input",13),e.k0s(),e.j41(22,"button",14),e.nrm(23,"mat-icon",15),e.j41(24,"span",16),e.EFF(25,"Agregar"),e.k0s()()()(),e.j41(26,"div",17)(27,"div",18),e.DNE(28,St,2,1),e.nI1(29,"async"),e.k0s()()()),2&o){let i;e.R7$(8),e.Y8G("svgIcon","mat_solid:chevron_right"),e.R7$(4),e.Y8G("svgIcon","mat_solid:chevron_right"),e.R7$(8),e.Y8G("svgIcon","mat_solid:search"),e.R7$(),e.Y8G("formControl",s.searchInputControl)("autocomplete","off")("placeholder","Escriba para buscar..."),e.R7$(),e.Y8G("routerLink",e.lJ4(11,vt)),e.R7$(),e.Y8G("svgIcon","mat_solid:add"),e.R7$(5),e.vxM(28,(i=e.bMT(29,9,s.vehicles$))?28:-1,i)}},dependencies:[w.Jj,I.Hl,I.$z,f.RG,f.rl,f.JW,W.m_,W.An,U.fS,U.fg,v.Ou,v.iy,J.D6,O.mV,S.NQ,S.B4,S.aE,w.YU,n.X1,n.me,n.BC,n.l_,A.Wk],encapsulation:2,changeDetection:0})}return r})();var B=p(60850),N=p(25084),X=p(82798),P=p(99172),$t=p(67943),Rt=p(56808),wt=p(56501),_e=p(65478),ae=p(86600);const Ie=r=>({"cursor-not-allowed":r});function Dt(r,c){if(1&r){const t=e.RV6();e.j41(0,"button",35),e.bIt("click",function(){e.eBV(t);const s=e.XpG();return e.Njj(s.createVehicle())}),e.nrm(1,"mat-icon",36),e.j41(2,"span",37),e.EFF(3,"Guardar"),e.k0s()()}if(2&r){const t=e.XpG();e.Y8G("disabled",t.vehicleForm.invalid)("ngClass",e.eq3(3,Ie,t.vehicleForm.invalid)),e.R7$(),e.Y8G("svgIcon","mat_solid:save")}}function jt(r,c){if(1&r){const t=e.RV6();e.j41(0,"button",35),e.bIt("click",function(){e.eBV(t);const s=e.XpG();return e.Njj(s.updateVehicle())}),e.nrm(1,"mat-icon",36),e.j41(2,"span",37),e.EFF(3,"Actualizar"),e.k0s()()}if(2&r){const t=e.XpG();e.Y8G("disabled",t.vehicleForm.invalid)("ngClass",e.eq3(3,Ie,t.vehicleForm.invalid)),e.R7$(),e.Y8G("svgIcon","mat_solid:refresh")}}function Wt(r,c){1&r&&(e.j41(0,"mat-error"),e.EFF(1," El n\xfamero de registro (chapa) es obligatorio. "),e.k0s())}function At(r,c){1&r&&(e.j41(0,"mat-error"),e.EFF(1," El n\xfamero de registro (chapa) debe tener 7 caracteres. "),e.k0s())}function Ot(r,c){if(1&r){const t=e.RV6();e.j41(0,"mat-option",38),e.bIt("click",function(){const s=e.eBV(t).$implicit,i=e.XpG();return e.Njj(i.selectCustomer(s))}),e.EFF(1),e.k0s()}if(2&r){const t=c.$implicit;e.Y8G("value",t),e.R7$(),e.SpI(" ",t.name," ")}}function Vt(r,c){if(1&r){const t=e.RV6();e.j41(0,"mat-option",38),e.bIt("click",function(){const s=e.eBV(t).$implicit,i=e.XpG();return e.Njj(i.selectBrand(s))}),e.EFF(1),e.k0s()}if(2&r){const t=c.$implicit;e.Y8G("value",t),e.R7$(),e.SpI(" ",t.name," ")}}function Tt(r,c){1&r&&(e.j41(0,"mat-error"),e.EFF(1," El modelo no debe tener m\xe1s de 50 caracteres. "),e.k0s())}function Gt(r,c){if(1&r){const t=e.RV6();e.j41(0,"mat-option",38),e.bIt("click",function(){const s=e.eBV(t).$implicit,i=e.XpG();return e.Njj(i.selectFuel(s))}),e.EFF(1),e.k0s()}if(2&r){const t=c.$implicit;e.Y8G("value",t),e.R7$(),e.SpI(" ",t.name," ")}}function Pt(r,c){1&r&&(e.j41(0,"mat-error"),e.EFF(1," El n\xfamero vin debe tener 17 caracteres. "),e.k0s())}function Mt(r,c){1&r&&(e.j41(0,"mat-error"),e.EFF(1," El n\xfamero del motor no debe tener m\xe1s de 50 caracteres. "),e.k0s())}function Bt(r,c){1&r&&(e.j41(0,"mat-error"),e.EFF(1," El n\xfamero de la carrocer\xeda no debe tener m\xe1s de 50 caracteres. "),e.k0s())}function Nt(r,c){1&r&&(e.j41(0,"mat-error"),e.EFF(1," El color no debe tener m\xe1s de 100 caracteres. "),e.k0s())}function zt(r,c){1&r&&(e.j41(0,"mat-error"),e.EFF(1," El comentario sobre la bater\xeda no debe tener m\xe1s de 1000000 caracteres. "),e.k0s())}function Lt(r,c){1&r&&(e.j41(0,"mat-error"),e.EFF(1," El comentario sobre la reproductora no debe tener m\xe1s de 1000000 caracteres. "),e.k0s())}let Yt=(()=>{class r{constructor(t,o,s,i,a,l){this._activatedRoute=t,this._changeDetectorRef=o,this._formBuilder=s,this._snackBar=i,this._router=a,this.store=l,this.brandSelected="",this.customers=[],this.customerSelected="",this.editMode=!1,this.fuelSelected="",this.isLoading=!1,this.isLoadingData=!0,this.searchBrandControl=new n.MJ(""),this.searchCustomerControl=new n.MJ(""),this.searchFuelControl=new n.MJ(""),this.selectedVehicle=new xe,this.vehicles$=(0,M.of)([]),this._unsubscribeAll=new x.B,this._fuseConfirmationService=(0,e.WQX)(V.G),this._vehiclesService=(0,e.WQX)(me)}ngOnInit(){this.store.select(Rt.wQ).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(t=>{this.customers=t,this._changeDetectorRef.markForCheck()}),this.customersFiltered$=this.searchCustomerControl.valueChanges.pipe((0,P.Z)(""),(0,y.T)(t=>{const o="string"==typeof t?t:t?.name;return o?this._filterCustomers(o):this.customers.slice()})),this.store.select($t.DC).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(t=>{this.brands=t,this._changeDetectorRef.markForCheck()}),this.brandsFiltered$=this.searchBrandControl.valueChanges.pipe((0,P.Z)(""),(0,y.T)(t=>{const o="string"==typeof t?t:t?.name;return o?this._filterBrands(o):this.brands.slice()})),this.store.select(wt.UC).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(t=>{this.fuels=t,this._changeDetectorRef.markForCheck()}),this.fuelsFiltered$=this.searchFuelControl.valueChanges.pipe((0,P.Z)(""),(0,y.T)(t=>{const o="string"==typeof t?t:t?.name;return o?this._filterFuels(o):this.fuels.slice()})),this.vehicleForm=this._formBuilder.group({id:new n.MJ(null),customerId:new n.MJ(null,[n.k0.required,n.k0.pattern(/^[0-9A-F]{8}-[0-9A-F]{4}-[4][0-9A-F]{3}-[89AB][0-9A-F]{3}-[0-9A-F]{12}$/i),n.k0.maxLength(255)]),brandId:new n.MJ(null,[n.k0.required,n.k0.pattern(/^[0-9A-F]{8}-[0-9A-F]{4}-[4][0-9A-F]{3}-[89AB][0-9A-F]{3}-[0-9A-F]{12}$/i),n.k0.maxLength(255)]),model:new n.MJ(null,[n.k0.maxLength(50)]),fuelId:new n.MJ(null,[n.k0.required,n.k0.pattern(/^[0-9A-F]{8}-[0-9A-F]{4}-[4][0-9A-F]{3}-[89AB][0-9A-F]{3}-[0-9A-F]{12}$/i),n.k0.maxLength(255)]),registrationNumber:new n.MJ(null,[n.k0.required,n.k0.minLength(7),n.k0.maxLength(7)]),vin:new n.MJ(null,[n.k0.minLength(17),n.k0.maxLength(17)]),engineNumber:new n.MJ(null,[n.k0.maxLength(50)]),bodyNumber:new n.MJ(null,[n.k0.maxLength(50)]),color:new n.MJ(null,[n.k0.maxLength(100)]),battery:new n.MJ(null,[n.k0.maxLength(1e6)]),carPlayer:new n.MJ(null,[n.k0.maxLength(1e6)])}),this._activatedRoute.params.pipe((0,m.Q)(this._unsubscribeAll)).subscribe(({vehicleId:t})=>{"new"!==t&&(this.editMode=!0,this.store.select(mt).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(o=>{this.selectedVehicle=o,this.isLoadingData=!1,this.vehicleForm.patchValue(o),this.isLoadingData=!1})),this._changeDetectorRef.markForCheck()})}ngOnDestroy(){this._unsubscribeAll.next(null),this._unsubscribeAll.complete()}createVehicle(){let t=this.vehicleForm.getRawValue();t=(0,$.omit)(t,["id","code"]),this._fuseConfirmationService.open({title:"Crear Veh\xedculo",message:"\xbfEsta seguro que toda la informaci\xf3n es correcta?",icon:{show:!0,name:"mat_solid:question_mark",color:"info"},actions:{confirm:{label:"Aceptar",color:"primary"}}}).afterClosed().subscribe(s=>{"confirmed"===s&&this._vehiclesService.createVehicle(t).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(({data:i})=>{this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:5e3,data:{message:i.createVehicle.message,title:"Confirmaci\xf3n",type:"success",svgIcon:"mat_solid:done"}}),this._changeDetectorRef.markForCheck(),this._router.navigateByUrl("/workshop/vehicles")}),this._changeDetectorRef.markForCheck()})}updateVehicle(){let t=this.vehicleForm.getRawValue();t=(0,$.omit)(t,["code"]),this._fuseConfirmationService.open({title:"Actualizar Veh\xedculo",message:"\xbfEsta seguro que toda la informaci\xf3n es correcta?",icon:{show:!0,name:"mat_solid:question_mark",color:"info"},actions:{confirm:{label:"Aceptar",color:"primary"}}}).afterClosed().subscribe(s=>{"confirmed"===s&&this._vehiclesService.updateVehicle(t).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(({data:i})=>{this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:5e3,data:{message:i.updateVehicle.message,title:"Confirmaci\xf3n",type:"success",svgIcon:"mat_solid:done"}}),this._router.navigateByUrl("/workshop/vehicles")}),this._changeDetectorRef.markForCheck()})}selectBrand(t){this.vehicleForm.get("brandId").setValue(t.id)}selectCustomer(t){this.vehicleForm.get("customerId").setValue(t.id)}selectFuel(t){this.vehicleForm.get("fuelId").setValue(t.id)}displayFn(t){return t&&t.name?t.name:""}_filterBrands(t){const o=t.toLowerCase();return this.customers.filter(s=>s.name.toLowerCase().includes(o))}_filterCustomers(t){const o=t.toLowerCase();return this.customers.filter(s=>s.name.toLowerCase().includes(o))}_filterFuels(t){const o=t.toLowerCase();return this.customers.filter(s=>s.name.toLowerCase().includes(o))}static#e=this.\u0275fac=function(o){return new(o||r)(e.rXU(A.nX),e.rXU(e.gRc),e.rXU(n.ok),e.rXU(j.UG),e.rXU(A.Ix),e.rXU(b.il))};static#t=this.\u0275cmp=e.VBU({type:r,selectors:[["workshop-vehicle-details"]],standalone:!0,features:[e.aNF],decls:107,vars:50,consts:[["customerAutocomplete","matAutocomplete"],["brandAutocomplete","matAutocomplete"],["fuelAutocomplete","matAutocomplete"],["cdkScrollable","",1,"flex","flex-col","flex-auto","min-w-0","sm:absolute","sm:inset-0","bg-card","dark:bg-transparent","overflow-y-auto"],[1,"z-20","flex","flex-col","p-6","border-b","sm:flex-row","flex-0","sm:items-center","sm:justify-between","sm:py-8","sm:px-10","bg-card","dark:bg-transparent"],[1,"flex-1","min-w-0"],[1,"flex-wrap","items-center","hidden","font-medium","sm:flex"],["routerLink","/desktop",1,"whitespace-nowrap","text-primary-500"],[1,"flex","items-center","ml-1","whitespace-nowrap"],[1,"icon-size-5","text-secondary",3,"svgIcon"],[1,"ml-1","text-primary-500"],["routerLink","/workshop/vehicles",1,"ml-1","text-primary-500"],[1,"mt-2"],[1,"text-3xl","font-extrabold","leading-7","tracking-tight","truncate","sm:leading-10"],[1,"flex","items-center","mt-6","shrink-0","sm:mt-0","sm:ml-4"],["mat-raised-button","",1,"text-white","bg-gradient-to-r","from-primary-500","to-primary-700",3,"disabled","ngClass"],[1,"flex","flex-auto"],[1,"flex","flex-col","w-full","divide-y","divide-dashed",3,"formGroup","autocomplete"],[1,"grid","grid-cols-1","p-10"],[1,"flex","flex-col"],[1,"text-xl","font-semibold"],[1,"flex","flex-col","p-6","mt-5","border","shadow-md","sm:flex-row","bg-card","rounded-2xl"],[1,"grid","grid-cols-1","sm:grid-cols-2","md:grid-cols-3","gap-5","w-full"],[1,"w-full","fuse-mat-dense"],["matInput","","type","text","minlength","7","maxlength","7","required","",3,"formControlName"],["appearance","fill",1,"w-full","fuse-mat-dense"],["matPrefix","",3,"svgIcon"],["type","text","matInput","",3,"formControl","matAutocomplete","placeholder","required"],[3,"displayWith"],[3,"value"],["matInput","","type","text","maxlength","50",3,"formControlName"],["matInput","","type","text","minlength","17","maxlength","17",3,"formControlName"],["matInput","","type","text","maxlength","100",3,"formControlName"],[1,"w-full","fuse-mat-dense","sm:col-span-3"],["matInput","","cdkTextareaAutosize","","maxlength","1000000","rows","2",3,"formControlName"],["mat-raised-button","",1,"text-white","bg-gradient-to-r","from-primary-500","to-primary-700",3,"click","disabled","ngClass"],[3,"svgIcon"],[1,"hidden","ml-2","mr-1","text-white","sm:block"],[3,"click","value"]],template:function(o,s){if(1&o&&(e.j41(0,"div",3)(1,"div",4)(2,"div",5)(3,"div")(4,"div",6)(5,"div")(6,"a",7),e.EFF(7,"Inicio"),e.k0s()(),e.j41(8,"div",8),e.nrm(9,"mat-icon",9),e.j41(10,"a",10),e.EFF(11,"Taller"),e.k0s()(),e.j41(12,"div",8),e.nrm(13,"mat-icon",9),e.j41(14,"a",11),e.EFF(15,"Veh\xedculos"),e.k0s()(),e.j41(16,"div",8),e.nrm(17,"mat-icon",9),e.j41(18,"a",10),e.EFF(19),e.k0s()()()(),e.j41(20,"div",12)(21,"h2",13),e.EFF(22),e.k0s()()(),e.j41(23,"div",14),e.DNE(24,Dt,4,5,"button",15)(25,jt,4,5,"button",15),e.k0s()(),e.j41(26,"div",16)(27,"form",17)(28,"div",18)(29,"div",19)(30,"span",20),e.EFF(31,"Generales"),e.k0s(),e.j41(32,"span"),e.EFF(33,"Ingrese la informaci\xf3n necesaria para describir e identificar el veh\xedculo"),e.k0s()(),e.j41(34,"div",21)(35,"div",22)(36,"mat-form-field",23)(37,"mat-label"),e.EFF(38,"Chapa"),e.k0s(),e.nrm(39,"input",24),e.DNE(40,Wt,2,0,"mat-error")(41,At,2,0,"mat-error"),e.k0s(),e.j41(42,"mat-form-field",25)(43,"mat-label"),e.EFF(44,"Cliente"),e.k0s(),e.nrm(45,"mat-icon",26)(46,"input",27),e.j41(47,"mat-autocomplete",28,0),e.Z7z(49,Ot,2,2,"mat-option",29,e.fX1),e.nI1(51,"async"),e.k0s()(),e.j41(52,"mat-form-field",25)(53,"mat-label"),e.EFF(54,"Marca"),e.k0s(),e.nrm(55,"mat-icon",26)(56,"input",27),e.j41(57,"mat-autocomplete",28,1),e.Z7z(59,Vt,2,2,"mat-option",29,e.fX1),e.nI1(61,"async"),e.k0s()(),e.j41(62,"mat-form-field",23)(63,"mat-label"),e.EFF(64,"Modelo"),e.k0s(),e.nrm(65,"input",30),e.DNE(66,Tt,2,0,"mat-error"),e.k0s(),e.j41(67,"mat-form-field",25)(68,"mat-label"),e.EFF(69,"Tipo de combustible"),e.k0s(),e.nrm(70,"mat-icon",26)(71,"input",27),e.j41(72,"mat-autocomplete",28,2),e.Z7z(74,Gt,2,2,"mat-option",29,e.fX1),e.nI1(76,"async"),e.k0s()(),e.j41(77,"mat-form-field",23)(78,"mat-label"),e.EFF(79,"VIN"),e.k0s(),e.nrm(80,"input",31),e.DNE(81,Pt,2,0,"mat-error"),e.k0s(),e.j41(82,"mat-form-field",23)(83,"mat-label"),e.EFF(84,"N\xfamero del motor"),e.k0s(),e.nrm(85,"input",30),e.DNE(86,Mt,2,0,"mat-error"),e.k0s(),e.j41(87,"mat-form-field",23)(88,"mat-label"),e.EFF(89,"N\xfamero de la carrocer\xeda"),e.k0s(),e.nrm(90,"input",30),e.DNE(91,Bt,2,0,"mat-error"),e.k0s(),e.j41(92,"mat-form-field",23)(93,"mat-label"),e.EFF(94,"Color"),e.k0s(),e.nrm(95,"input",32),e.DNE(96,Nt,2,0,"mat-error"),e.k0s(),e.j41(97,"mat-form-field",33)(98,"mat-label"),e.EFF(99,"Sobre la bater\xeda"),e.k0s(),e.nrm(100,"textarea",34),e.DNE(101,zt,2,0,"mat-error"),e.k0s(),e.j41(102,"mat-form-field",33)(103,"mat-label"),e.EFF(104,"Sobre la reproductora"),e.k0s(),e.nrm(105,"textarea",34),e.DNE(106,Lt,2,0,"mat-error"),e.k0s()()()()()()()),2&o){const i=e.sdS(48),a=e.sdS(58),l=e.sdS(73);e.R7$(9),e.Y8G("svgIcon","mat_solid:chevron_right"),e.R7$(4),e.Y8G("svgIcon","mat_solid:chevron_right"),e.R7$(4),e.Y8G("svgIcon","mat_solid:chevron_right"),e.R7$(2),e.SpI(" ",s.editMode?s.selectedVehicle.registrationNumber:"Nuevo"," "),e.R7$(3),e.SpI(" ",s.editMode?s.selectedVehicle.registrationNumber:"Nuevo"," "),e.R7$(2),e.vxM(24,s.editMode?-1:24),e.R7$(),e.vxM(25,s.editMode?25:-1),e.R7$(2),e.Y8G("formGroup",s.vehicleForm)("autocomplete","off"),e.R7$(12),e.Y8G("formControlName","registrationNumber"),e.R7$(),e.vxM(40,s.vehicleForm.get("registrationNumber").hasError("required")?40:-1),e.R7$(),e.vxM(41,s.vehicleForm.get("registrationNumber").hasError("minlength")?41:-1),e.R7$(4),e.Y8G("svgIcon","mat_solid:search"),e.R7$(),e.Y8G("formControl",s.searchCustomerControl)("matAutocomplete",i)("placeholder","Buscar cliente")("required",!0),e.R7$(),e.Y8G("displayWith",s.displayFn),e.R7$(2),e.Dyx(e.bMT(51,44,s.customersFiltered$)),e.R7$(6),e.Y8G("svgIcon","mat_solid:search"),e.R7$(),e.Y8G("formControl",s.searchBrandControl)("matAutocomplete",a)("placeholder","Buscar marca")("required",!0),e.R7$(),e.Y8G("displayWith",s.displayFn),e.R7$(2),e.Dyx(e.bMT(61,46,s.brandsFiltered$)),e.R7$(6),e.Y8G("formControlName","model"),e.R7$(),e.vxM(66,s.vehicleForm.get("model").hasError("maxlength")?66:-1),e.R7$(4),e.Y8G("svgIcon","mat_solid:search"),e.R7$(),e.Y8G("formControl",s.searchFuelControl)("matAutocomplete",l)("placeholder","Buscar combustible")("required",!0),e.R7$(),e.Y8G("displayWith",s.displayFn),e.R7$(2),e.Dyx(e.bMT(76,48,s.fuelsFiltered$)),e.R7$(6),e.Y8G("formControlName","vin"),e.R7$(),e.vxM(81,s.vehicleForm.get("vin").hasError("minlength")?81:-1),e.R7$(4),e.Y8G("formControlName","engineNumber"),e.R7$(),e.vxM(86,s.vehicleForm.get("engineNumber").hasError("maxlength")?86:-1),e.R7$(4),e.Y8G("formControlName","bodyNumber"),e.R7$(),e.vxM(91,s.vehicleForm.get("bodyNumber").hasError("maxlength")?91:-1),e.R7$(4),e.Y8G("formControlName","color"),e.R7$(),e.vxM(96,s.vehicleForm.get("color").hasError("maxlength")?96:-1),e.R7$(4),e.Y8G("formControlName","battery"),e.R7$(),e.vxM(101,s.vehicleForm.get("carPlayer").hasError("maxlength")?101:-1),e.R7$(4),e.Y8G("formControlName","carPlayer"),e.R7$(),e.vxM(106,s.vehicleForm.get("carPlayer").hasError("maxlength")?106:-1)}},dependencies:[w.Jj,n.YN,n.qT,n.me,n.BC,n.cb,n.YS,n.xh,n.tU,B.jL,_e.uv,B.$3,ae.wT,B.pN,I.Hl,I.$z,N.X6,h.hM,f.RG,f.rl,f.nJ,f.TL,f.JW,W.m_,W.An,X.Ve,w.YU,n.X1,n.l_,n.j4,n.JD],encapsulation:2,changeDetection:0})}return r})();const Ce=r=>r.vehicleInspections,Ut=(0,b.Mz)(Ce,r=>r.vehicleInspection),ce=(0,b.Mz)(Ce,r=>r.vehicleInspections);class ye{}var le=p(32998);const Xt=g.J1`
...
`;let ge=(()=>{class r{constructor(t,o,s){this.apolloProvider=t,this._snackBar=o,this.store=s,this._apollo=this.apolloProvider.use("BALANC")}createWorkshopService(t){return this.store.select(re).pipe((0,E.s)(1),(0,_.n)(o=>this._apollo.mutate({mutation:_r,variables:{createWorkshopServiceInput:t},errorPolicy:"all"}).pipe((0,k.M)(({errors:s,data:i})=>{if(s){let l="";s.forEach(d=>l+=`\n ${d.message}.`),this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:l,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}const a=(0,$.cloneDeep)(o);a.push(i.createWorkshopService.workshopService),this.store.dispatch((0,se.MU)({workshopServices:a}))}))))}getWorkshopServices(t=1,o=20,s="no",i="asc",a=""){return this._apollo.query({query:br,errorPolicy:"all",variables:{offset:o*(t-1),limit:o,sort:s,order:i,search:a}}).pipe((0,k.M)(({errors:l,data:d})=>{if(l){let F="";l.forEach(q=>F+=`\n ${q.message}.`),this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:F,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}this.store.dispatch((0,ie.Bp)({pagination:d.findWorkshopServices.pagination})),this.store.dispatch((0,se.MU)({workshopServices:d.findWorkshopServices.workshopServices}))}))}getAllWorkshopServices(){return this._apollo.query({query:Fr,errorPolicy:"all"}).pipe((0,k.M)(({errors:t})=>{if(t){let o="";t.forEach(s=>o+=`\n ${s.message}.`),this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:o,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}}))}getWorkshopServiceById(t){return this._apollo.query({query:xr,variables:{findWorkshopServiceByIdId:t},errorPolicy:"all"}).pipe((0,k.M)(({errors:o,data:s})=>{if(o){let i="";o.forEach(a=>i+=`\n ${a.message}.`),this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:i,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}this.store.dispatch((0,se.ho)({workshopService:s.findWorkshopServiceById.workshopService}))}))}updateWorkshopService(t){return this.store.select(re).pipe((0,E.s)(1),(0,_.n)(o=>this._apollo.mutate({mutation:gr,variables:{updateWorkshopServiceInput:t},errorPolicy:"all"}).pipe((0,k.M)(({errors:s,data:i})=>{if(s){let d="";s.forEach(F=>d+=`\n ${F.message}.`),this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:d,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}const a=(0,$.cloneDeep)(o);a[o.findIndex(d=>d.id===t.id)]=i.updateWorkshopService.workshopService,this.store.dispatch((0,se.MU)({workshopServices:a}))}))))}updateWorkshopServiceStatus(t){return this.store.select(re).pipe((0,E.s)(1),(0,_.n)(o=>this._apollo.mutate({mutation:vr,variables:{updateEntityStatusInput:t},errorPolicy:"all"}).pipe((0,k.M)(({errors:s})=>{if(s){let l="";s.forEach(d=>l+=`\n ${d.message}.`),this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:l,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}const i=(0,$.cloneDeep)(o);i[o.findIndex(l=>l.id===t.id)].active=t.active,this.store.dispatch((0,se.MU)({workshopServices:i}))}))))}removeWorkshopService(t){return this.store.select(re).pipe((0,E.s)(1),(0,_.n)(o=>this._apollo.mutate({mutation:kr,variables:{removeWorkshopServiceId:t},errorPolicy:"all"}).pipe((0,k.M)(({errors:s})=>{if(s){let l="";s.forEach(d=>l+=`\n ${d.message}.`),this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:l,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}const i=(0,$.cloneDeep)(o),a=o.findIndex(l=>l.id===t);i.splice(a,1),this.store.dispatch((0,se.MU)({workshopServices:i}))}))))}static#e=this.\u0275fac=function(o){return new(o||r)(e.KVO(g.Ic),e.KVO(j.UG),e.KVO(b.il))};static#t=this.\u0275prov=e.jDH({token:r,factory:r.\u0275fac,providedIn:"root"})}return r})();function Ir(r,c){1&r&&(e.j41(0,"h2",2),e.EFF(1," Agregar servicio de taller "),e.k0s())}function Cr(r,c){1&r&&(e.j41(0,"h2",2),e.EFF(1," Editar servicio de taller "),e.k0s())}function yr(r,c){if(1&r&&(e.j41(0,"div",4)(1,"div",7)(2,"div",8)(3,"div",9)(4,"div",10)(5,"h6",11),e.EFF(6,"Nombre"),e.k0s(),e.j41(7,"span",12),e.EFF(8),e.k0s()()()()()()),2&r){const t=e.XpG();e.R7$(8),e.JRh(t.data.workshopService.description||"Sin nombre")}}function Sr(r,c){1&r&&(e.j41(0,"mat-error"),e.EFF(1," La descripci\xf3n del es obligatoria "),e.k0s())}function Er(r,c){if(1&r&&(e.j41(0,"mat-option",19),e.EFF(1),e.k0s()),2&r){const t=c.$implicit;e.Y8G("value",t.id),e.R7$(),e.SpI(" ",t.iso," ")}}function $r(r,c){1&r&&(e.j41(0,"mat-error"),e.EFF(1," La moneda es obligatoria "),e.k0s())}function Rr(r,c){1&r&&(e.j41(0,"mat-error"),e.EFF(1," El precio m\xednimo es obligatorio "),e.k0s())}function wr(r,c){1&r&&(e.j41(0,"mat-error"),e.EFF(1," El precio m\xe1ximo es obligatorio "),e.k0s())}function Dr(r,c){if(1&r&&(e.j41(0,"div",5)(1,"div",13)(2,"form",14)(3,"mat-form-field",15)(4,"mat-label"),e.EFF(5,"Descripci\xf3n"),e.k0s(),e.nrm(6,"input",16),e.j41(7,"mat-hint"),e.EFF(8,"Ejemplo: Monte y desmonte de caja"),e.k0s(),e.DNE(9,Sr,2,0,"mat-error"),e.k0s(),e.j41(10,"mat-form-field",17)(11,"mat-label"),e.EFF(12,"Moneda"),e.k0s(),e.j41(13,"mat-select",18),e.Z7z(14,Er,2,2,"mat-option",19,e.fX1),e.k0s(),e.DNE(16,$r,2,0,"mat-error"),e.k0s(),e.j41(17,"mat-form-field",17)(18,"mat-label"),e.EFF(19,"Precio M\xednimo"),e.k0s(),e.nrm(20,"input",20),e.DNE(21,Rr,2,0,"mat-error"),e.k0s(),e.j41(22,"mat-form-field",17)(23,"mat-label"),e.EFF(24,"Precio M\xe1ximo"),e.k0s(),e.nrm(25,"input",21),e.DNE(26,wr,2,0,"mat-error"),e.k0s()()()()),2&r){const t=e.XpG();e.R7$(2),e.Y8G("formGroup",t.workshopServiceForm)("autocomplete","off"),e.R7$(4),e.Y8G("formControlName","description")("placeholder","Ejemplo: Monte y desmonte de caja"),e.R7$(3),e.vxM(9,t.workshopServiceForm.get("description").hasError("required")?9:-1),e.R7$(4),e.Y8G("formControlName","currencyId")("required",!0),e.R7$(),e.Dyx(t.currencies),e.R7$(2),e.vxM(16,t.workshopServiceForm.get("currencyId").hasError("required")?16:-1),e.R7$(4),e.Y8G("formControlName","minPrice")("placeholder","0.00"),e.R7$(),e.vxM(21,t.workshopServiceForm.get("minPrice").hasError("required")?21:-1),e.R7$(4),e.Y8G("formControlName","maxPrice")("min",t.workshopServiceForm.get("minPrice").value)("placeholder","0.00"),e.R7$(),e.vxM(26,t.workshopServiceForm.get("maxPrice").hasError("required")?26:-1)}}function jr(r,c){if(1&r){const t=e.RV6();e.j41(0,"button",24),e.bIt("click",function(){e.eBV(t);const s=e.XpG(2);return e.Njj(s.updateWorkshopService())}),e.EFF(1," Actualizar "),e.k0s()}if(2&r){const t=e.XpG(2);e.Y8G("color","primary")("disabled",t.workshopServiceForm.invalid)("matDialogClose","confirmed")}}function Wr(r,c){if(1&r){const t=e.RV6();e.j41(0,"button",24),e.bIt("click",function(){e.eBV(t);const s=e.XpG(2);return e.Njj(s.createWorkshopService())}),e.EFF(1," Agregar "),e.k0s()}if(2&r){const t=e.XpG(2);e.Y8G("color","primary")("disabled",t.workshopServiceForm.invalid)("matDialogClose","confirmed")}}function Ar(r,c){if(1&r&&(e.j41(0,"div",6)(1,"button",22),e.EFF(2," Cancelar "),e.k0s(),e.DNE(3,jr,2,3,"button",23)(4,Wr,2,3,"button",23),e.k0s()),2&r){const t=e.XpG();e.R7$(),e.Y8G("matDialogClose","cancelled"),e.R7$(2),e.vxM(3,"edit"===t.data.dialogMode?3:-1),e.R7$(),e.vxM(4,"add"===t.data.dialogMode?4:-1)}}let Or=(()=>{class r{constructor(t,o,s,i,a,l,d){this.data=t,this._changeDetectorRef=o,this._formBuilder=s,this._fuseConfirmationService=i,this._dialogRef=a,this._snackBar=l,this.store=d,this.currencies=[],this.maxDate=new Date,this.dialogMode="view",this._unsubscribeAll=new x.B,this._workshopServicesService=(0,e.WQX)(ge),this.dialogMode=t.dialogMode,this.workshopService=t.workshopService}ngOnInit(){this.workshopServiceForm=this._formBuilder.group({id:new n.MJ(null),description:new n.MJ(null,[n.k0.required,n.k0.maxLength(1e5)]),minPrice:new n.MJ(0,[n.k0.required,n.k0.min(0)]),maxPrice:new n.MJ(0,[n.k0.required]),currencyId:new n.MJ(null,[n.k0.required,n.k0.maxLength(100)])}),"edit"===this.dialogMode&&this.workshopServiceForm.patchValue(this.workshopService),this.store.select(fr.y$).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(t=>{this.currencies=t,this._changeDetectorRef.markForCheck()})}ngOnDestroy(){this._unsubscribeAll.next(null),this._unsubscribeAll.complete()}closeDialog(){this._dialogRef.close()}createWorkshopService(){let t=this.workshopServiceForm.getRawValue();t=(0,G.A)(t,["id"]),this._fuseConfirmationService.open({title:"Crear servicio de taller",message:"\xbfEsta seguro que toda la informaci\xf3n es correcta?",icon:{show:!0,name:"mat_solid:question_mark",color:"info"},actions:{confirm:{label:"Aceptar",color:"primary"}}}).afterClosed().subscribe(s=>{"confirmed"===s&&this._workshopServicesService.createWorkshopService(t).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(({data:i})=>{this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:5e3,data:{message:i.createWorkshopService.message,title:"Confirmaci\xf3n",type:"success",svgIcon:"mat_solid:done"}})}),this._changeDetectorRef.markForCheck()})}updateWorkshopService(){const t=this.workshopServiceForm.getRawValue();this._fuseConfirmationService.open({title:"Actualizar servicio de taller",message:"\xbfEsta seguro que toda la informaci\xf3n es correcta?",icon:{show:!0,name:"mat_solid:question_mark",color:"info"},actions:{confirm:{label:"Aceptar",color:"primary"}}}).afterClosed().subscribe(s=>{"confirmed"===s&&this._workshopServicesService.updateWorkshopService(t).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(({data:i})=>{this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:5e3,data:{message:i.updateWorkshopService.message,title:"Confirmaci\xf3n",type:"success",svgIcon:"mat_solid:done"}})}),this._changeDetectorRef.markForCheck()})}static#e=this.\u0275fac=function(o){return new(o||r)(e.rXU(h.Vh),e.rXU(e.gRc),e.rXU(n.ok),e.rXU(V.G),e.rXU(h.CP),e.rXU(j.UG),e.rXU(b.il))};static#t=this.\u0275cmp=e.VBU({type:r,selectors:[["workshop-service-dialog"]],standalone:!0,features:[e.aNF],decls:8,vars:5,consts:[[1,"relative","flex","flex-col","w-full","max-h-screenl"],[1,"flex","flex-col","items-center","px-8","pt-4","space-y-1","text-center","sm:items-start","sm:mt-0","sm:pr-8","sm:text-left"],[1,"text-2xl","text-gray-400"],[1,"flex","flex-col","items-center","flex-auto","w-full","px-8","pb-6","sm:flex-row","sm:items-start","sm:pb-8"],[1,"flex-auto"],[1,"w-full","overflow-hidden"],[1,"flex","items-center","justify-center","px-6","py-4","space-x-3","sm:justify-end","bg-gray-50","dark:bg-black/10"],[1,"flex"],[1,"flex","flex-col","w-full","mt-5"],[1,"flex","flex-col","p-8","pb-0","sm:flex-row"],[1,"w-full","py-10","my-10"],[1,"mb-2","font-medium"],[1,"border-sm"],[1,"flex","flex-col"],[1,"grid","w-full","grid-cols-1","gap-5","mt-3","sm:grid-cols-3",3,"formGroup","autocomplete"],[1,"w-full","fuse-mat-dense","sm:col-span-3"],["matInput","","type","text","required","","maxlength","50",3,"formControlName","placeholder"],[1,"w-full","fuse-mat-dense"],[3,"formControlName","required"],[3,"value"],["matInput","","type","number","required","","min","0",3,"formControlName","placeholder"],["matInput","","type","number","required","",3,"formControlName","min","placeholder"],["mat-stroked-button","",3,"matDialogClose"],["mat-flat-button","",3,"color","disabled","matDialogClose"],["mat-flat-button","",3,"click","color","disabled","matDialogClose"]],template:function(o,s){1&o&&(e.j41(0,"div",0)(1,"div",1),e.DNE(2,Ir,2,0,"h2",2)(3,Cr,2,0,"h2",2),e.k0s(),e.j41(4,"div",3),e.DNE(5,yr,9,1,"div",4)(6,Dr,27,15,"div",5),e.k0s(),e.DNE(7,Ar,5,3,"div",6),e.k0s()),2&o&&(e.R7$(2),e.vxM(2,"add"===s.data.dialogMode?2:-1),e.R7$(),e.vxM(3,"edit"===s.data.dialogMode?3:-1),e.R7$(2),e.vxM(5,"view"===s.data.dialogMode?5:-1),e.R7$(),e.vxM(6,6),e.R7$(),e.vxM(7,"view"!==s.data.dialogMode?7:-1))},dependencies:[h.hM,h.tx,n.X1,n.qT,n.me,n.Q0,n.BC,n.cb,n.YS,n.tU,n.VZ,n.j4,n.JD,f.RG,f.rl,f.nJ,f.MV,f.TL,I.Hl,I.$z,X.Ve,X.VO,ae.wT],encapsulation:2})}return r})();var Vr=p(68824);class Tr{}const Gr=r=>({"pointer-events-none":r}),Pr=()=>[5,10,25,100];function Mr(r,c){if(1&r){const t=e.RV6();e.j41(0,"mat-slide-toggle",38),e.bIt("change",function(s){e.eBV(t);const i=e.XpG(),a=i.$implicit,l=i.$index,d=e.XpG(2);return e.Njj(d.updateRateStatus(s,a,l))}),e.k0s()}if(2&r){const t=e.XpG().$implicit;e.Y8G("checked",t.active)("color","primary")}}function Br(r,c){1&r&&e.nrm(0,"mat-spinner",34),2&r&&e.Y8G("diameter",20)("color","primary")}function Nr(r,c){if(1&r){const t=e.RV6();e.j41(0,"div",28)(1,"div",30),e.EFF(2),e.k0s(),e.j41(3,"div",31),e.EFF(4),e.k0s(),e.j41(5,"div",32),e.EFF(6),e.nI1(7,"currency"),e.k0s(),e.j41(8,"div",32),e.EFF(9),e.nI1(10,"currency"),e.k0s(),e.j41(11,"div",27),e.DNE(12,Mr,1,2,"mat-slide-toggle",33)(13,Br,1,2,"mat-spinner",34),e.k0s(),e.j41(14,"div",35)(15,"button",36),e.bIt("click",function(){const s=e.eBV(t).$implicit,i=e.XpG(2);return e.Njj(i.openDialog(s,"edit"))}),e.nrm(16,"mat-icon",37),e.k0s(),e.j41(17,"button",36),e.bIt("click",function(){const s=e.eBV(t).$implicit,i=e.XpG(2);return e.Njj(i.deleteWorkshopService(s))}),e.nrm(18,"mat-icon",37),e.k0s()()()}if(2&r){const t=c.$implicit,o=c.$index,s=e.XpG(2);e.R7$(2),e.SpI(" ",t.no," "),e.R7$(2),e.SpI(" ",t.description," "),e.R7$(2),e.SpI(" ",e.brH(7,8,t.minPrice,t.currency.iso+" ","symbol")," "),e.R7$(3),e.SpI(" ",e.brH(10,12,t.maxPrice,t.currency.iso+" ","symbol")," "),e.R7$(3),e.vxM(12,s.isSlideLoading&&s.selectedSlide===o?-1:12),e.R7$(),e.vxM(13,s.isSlideLoading&&s.selectedSlide===o?13:-1),e.R7$(3),e.Y8G("svgIcon","mat_solid:edit"),e.R7$(2),e.Y8G("svgIcon","mat_solid:delete")}}function zr(r,c){if(1&r&&(e.j41(0,"div",23)(1,"div",24)(2,"div",25),e.EFF(3," No "),e.k0s(),e.j41(4,"div",26),e.EFF(5," Descripci\xf3n "),e.k0s(),e.j41(6,"div",27),e.EFF(7," Precio M\xednimo "),e.k0s(),e.j41(8,"div",27),e.EFF(9," Precio M\xe1ximo "),e.k0s(),e.j41(10,"div",27),e.EFF(11," Estado "),e.k0s(),e.j41(12,"div",27),e.EFF(13," Acciones "),e.k0s()(),e.Z7z(14,Nr,19,16,"div",28,e.BUC().trackByFn,!0),e.nrm(16,"mat-paginator",29),e.k0s()),2&r){const t=e.XpG();e.R7$(2),e.Y8G("mat-sort-header","no"),e.R7$(12),e.Dyx(t.workshopServices),e.R7$(2),e.Y8G("ngClass",e.eq3(7,Gr,t.isLoading))("length",t.pagination.length)("pageIndex",t.pagination.page)("pageSize",t.pagination.size)("pageSizeOptions",e.lJ4(9,Pr))("showFirstLastButtons",!0)}}function Lr(r,c){1&r&&(e.j41(0,"div",39),e.EFF(1," \xa1No hay servicios creados para el taller!"),e.k0s())}T.vfs=$e.b.vfs;let Yr=(()=>{class r{constructor(t,o,s,i){this._changeDetectorRef=t,this._dialog=o,this._snackBar=s,this.store=i,this.isLoading=!1,this.isSlideLoading=!1,this.merchant=null,this.searchInputControl=new n.MJ(""),this.selectedSlide=null,this.user=null,this.workshopService=new Tr,this.workshopServices=[],this._unsubscribeAll=new x.B,this._workshopServicesService=(0,e.WQX)(ge),this._fuseConfirmationService=(0,e.WQX)(V.G),this._fileSaverService=(0,e.WQX)(Vr.f)}ngOnInit(){this.store.select(Re.SW).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(t=>{this.user=t,this._changeDetectorRef.markForCheck()}),this.store.select(De.Xb).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(t=>{this.merchant=t,this._changeDetectorRef.markForCheck()}),this.store.select(re).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(t=>{this.workshopServices=t,this._changeDetectorRef.markForCheck()}),this.store.select(C.Dz).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(t=>{this.pagination=t,this._changeDetectorRef.markForCheck()}),this.searchInputControl.valueChanges.pipe((0,m.Q)(this._unsubscribeAll),(0,je.B)(300),(0,_.n)(t=>(this.isLoading=!0,this._workshopServicesService.getWorkshopServices(this._paginator.pageIndex+1,this._paginator.pageSize,this._sort.active,this._sort.direction,t))),(0,y.T)(()=>{this.isLoading=!1})).subscribe()}ngAfterViewInit(){this._sort&&this._paginator&&(this._sort.sort({id:"no",start:"asc",disableClear:!0}),this._changeDetectorRef.markForCheck(),this._sort.sortChange.pipe((0,m.Q)(this._unsubscribeAll)).subscribe(()=>{this._paginator.pageIndex=0}),(0,Y.h)(this._sort.sortChange,this._paginator.page).pipe((0,_.n)(()=>(this.isLoading=!0,this._workshopServicesService.getWorkshopServices(this._paginator.pageIndex+1,this._paginator.pageSize,this._sort.active,this._sort.direction,this.searchInputControl.value))),(0,y.T)(()=>{this.isLoading=!1})).subscribe())}ngOnDestroy(){this._unsubscribeAll.next(null),this._unsubscribeAll.complete()}deleteWorkshopService(t){this._fuseConfirmationService.open({title:"Cuidado",message:`\xbfEst\xe1 seguro que desea eliminar la orden de trabajo: ${t.no}?`,icon:{show:!0,name:"mat_solid:question_mark",color:"warning"},actions:{confirm:{label:"Aceptar",color:"primary"}}}).afterClosed().pipe((0,m.Q)(this._unsubscribeAll)).subscribe(s=>{"confirmed"===s&&this._workshopServicesService.removeWorkshopService(t.id).pipe((0,m.Q)(this._unsubscribeAll)).subscribe(({data:i})=>{this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:5e3,data:{message:i.removeWorkshopService.message,title:"Confirmaci\xf3n",type:"success",svgIcon:"mat_solid:done"}}),this._changeDetectorRef.markForCheck()})})}updateRateStatus(t,o,s){this.isSlideLoading=!0,this.selectedSlide=s,this._workshopServicesService.updateWorkshopServiceStatus({id:o.id,active:t.checked}).subscribe(({data:i})=>{this._snackBar.openFromComponent(u.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:5e3,data:{message:i.updateWorkshopServiceStatus.message,title:"Confirmaci\xf3n",type:"success",svgIcon:"mat_solid:done"}}),this.isSlideLoading=!1,this.selectedSlide=null,this._changeDetectorRef.markForCheck()})}openDialog(t,o){this._dialog.open(Or,{data:{workshopService:t,dialogMode:o},panelClass:"ath-dialog-panel"})}printWorkshopServicesList(t="open"){this._workshopServicesService.getAllWorkshopServices().pipe((0,E.s)(1)).subscribe(({data:o})=>{const s={header:{text:"Listado de servicios",style:"header",marginTop:5},content:[{lineHeight:1.3,table:{headerRows:1,widths:[60,"*",120,120],body:[[{text:"No.",style:"table_header"},{text:"Descripci\xf3n",style:"table_header",alignment:"left"},{text:"Precio M\xednimo",style:"table_header"},{text:"Precio M\xe1ximo",style:"table_header"}],...o.findAllWorkshopServices.workshopServices.map(i=>[{style:"table_body",text:i.no,alignment:"center"},{style:"table_body",text:i.description,alignment:"left"},{style:"table_body",text:i.currency.iso+" "+i.minPrice.toFixed(2),alignment:"right"},{style:"table_body",text:i.currency.iso+" "+i.maxPrice.toFixed(2),alignment:"right"}])]},layout:"lightHorizontalLines"}],footer:(i,a)=>({table:{widths:["*","*"],body:[[{text:`Reporte generador por: ${this.user.name} ${this.user.lastname1} ${this.user.lastname2} | Esta informaci\xf3n es exclusiva de ${this.merchant.name}`,bold:!0,fontSize:8},{text:`P\xe1gina ${i.toString()}/${a} - Fecha de impresi\xf3n ${z().format("DD/MM/yyyy HH:mm:ss")}`,bold:!0,fontSize:8,alignment:"right"}]]},margin:[30,0,30,0],layout:"noBorders",italics:!0}),defaultStyle:{fontSize:12},styles:{header:{fontSize:18,bold:!0,marginBottom:5,alignment:"center",fontFeatures:["c2sc","smcp"]},table_header:{fontSize:11,bold:!0,alignment:"center",fontFeatures:["c2sc","smcp"]},table_body:{fontSize:10}},pageOrientation:"landscape",pageSize:"LETTER",watermark:{text:this.merchant.name,color:"#fff",opacity:.07,angle:-35,bold:!0,italics:!1},info:{title:"Listado de servicios",author:`${this.user.name} ${this.user.lastname1} ${this.user.lastname2}`,creationDate:z().toDate(),modDate:z().toDate(),producer:this.merchant.name}};switch(t){case t="download":T.createPdf(s).download();break;case t="open":T.createPdf(s).open();break;case t="print":T.createPdf(s).print()}})}exportWorkshopServicesListToExcel(){this._workshopServicesService.getAllWorkshopServices().pipe((0,E.s)(1)).subscribe(({data:t})=>{this._fileSaverService.exportAsExcelFile(t.findAllWorkshopServices.workshopServices,"Listado de servicios")})}trackByFn(t,o){return o.id||t}static#e=this.\u0275fac=function(o){return new(o||r)(e.rXU(e.gRc),e.rXU(h.bZ),e.rXU(j.UG),e.rXU(b.il))};static#t=this.\u0275cmp=e.VBU({type:r,selectors:[["workshop-services"]],viewQuery:function(o,s){if(1&o&&(e.GBs(v.iy,5),e.GBs(S.B4,5)),2&o){let i;e.mGM(i=e.lsd())&&(s._paginator=i.first),e.mGM(i=e.lsd())&&(s._sort=i.first)}},standalone:!0,features:[e.aNF],decls:42,vars:13,consts:[["itemMenu","matMenu"],[1,"flex","flex-col","flex-auto","min-w-0","sm:absolute","sm:inset-0","sm:overflow-hidden","bg-card","dark:bg-transparent"],[1,"relative","flex","flex-col","px-6","py-8","border-b","sm:flex-row","flex-0","sm:items-center","sm:justify-between","md:px-8"],[1,"flex-1","min-w-0"],[1,"flex","flex-wrap","items-center","font-medium"],["routerLink","/desktop",1,"whitespace-nowrap","text-primary-500"],[1,"flex","items-center","ml-1","whitespace-nowrap"],[1,"icon-size-5","text-secondary",3,"svgIcon"],[1,"ml-1","text-primary-500"],[1,"mt-2"],[1,"text-3xl","font-extrabold","leading-7","tracking-tight","truncate","sm:leading-10"],[1,"flex","items-center","gap-2","mt-6","shrink-0","sm:mt-0","sm:ml-4"],[1,"fuse-mat-dense","fuse-mat-rounded","min-w-64"],["matPrefix","",1,"icon-size-5",3,"svgIcon"],["matInput","",3,"formControl","autocomplete","placeholder"],["mat-raised-button","",1,"text-white","bg-gradient-to-r","from-yellow-500","to-yellow-600",3,"matMenuTriggerFor"],[3,"svgIcon"],[1,"hidden","ml-2","mr-1","text-white","sm:block"],[3,"xPosition"],["mat-menu-item","",3,"click"],["mat-raised-button","",1,"text-white","bg-gradient-to-r","from-primary-500","to-primary-700",3,"click"],[1,"flex","flex-auto","overflow-hidden"],[1,"flex","flex-col","flex-auto","overflow-auto","sm:mb-18"],[1,"grid"],["matSort","","matSortDisableClear","",1,"sticky","top-0","z-10","grid","gap-4","px-6","py-4","font-semibold","shadow","workshops-services-grid","md:px-8","text-md","text-secondary","bg-gray-50","dark:bg-slate-900"],[1,"hidden","sm:block",3,"mat-sort-header"],[1,"text-left"],[1,"text-center"],[1,"grid","items-center","gap-4","px-6","py-3","border-b","workshops-services-grid","md:px-8"],[1,"z-10","border-b","sm:absolute","sm:inset-x-0","sm:bottom-0","sm:border-t","sm:border-b-0","bg-gray-50","dark:bg-transparent",3,"ngClass","length","pageIndex","pageSize","pageSizeOptions","showFirstLastButtons"],[1,"hidden","font-mono","sm:block"],[1,"text-left","truncate"],[1,"font-mono","text-center"],[3,"checked","color"],[3,"diameter","color"],[1,"flex","flex-row","items-center","justify-start","gap-1"],["mat-stroked-button","",1,"px-2","leading-6","min-w-10","min-h-7","h-7",3,"click"],[1,"icon-size-5",3,"svgIcon"],[3,"change","checked","color"],[1,"p-8","text-4xl","font-semibold","tracking-tight","text-center","border-t","sm:p-16"]],template:function(o,s){if(1&o){const i=e.RV6();e.j41(0,"div",1)(1,"div",2)(2,"div",3)(3,"div",4)(4,"div")(5,"a",5),e.EFF(6,"Inicio"),e.k0s()(),e.j41(7,"div",6),e.nrm(8,"mat-icon",7),e.j41(9,"a",8),e.EFF(10,"Taller"),e.k0s()(),e.j41(11,"div",6),e.nrm(12,"mat-icon",7),e.j41(13,"a",8),e.EFF(14,"Servicios"),e.k0s()()(),e.j41(15,"div",9)(16,"h2",10),e.EFF(17," Servicios "),e.k0s()()(),e.j41(18,"div",11)(19,"mat-form-field",12),e.nrm(20,"mat-icon",13)(21,"input",14),e.k0s(),e.j41(22,"button",15),e.nrm(23,"mat-icon",16),e.j41(24,"span",17),e.EFF(25,"Reportes"),e.k0s()(),e.j41(26,"mat-menu",18,0)(28,"button",19),e.bIt("click",function(){return e.eBV(i),e.Njj(s.printWorkshopServicesList())}),e.nrm(29,"mat-icon",16),e.EFF(30," Imprimir listado de servicios "),e.k0s(),e.j41(31,"button",19),e.bIt("click",function(){return e.eBV(i),e.Njj(s.exportWorkshopServicesListToExcel())}),e.nrm(32,"mat-icon",16),e.EFF(33," Exportar listado de servicios "),e.k0s()(),e.j41(34,"button",20),e.bIt("click",function(){return e.eBV(i),e.Njj(s.openDialog(s.workshopService,"add"))}),e.nrm(35,"mat-icon",16),e.j41(36,"span",17),e.EFF(37,"Agregar"),e.k0s()()()(),e.j41(38,"div",21)(39,"div",22),e.DNE(40,zr,17,10,"div",23)(41,Lr,2,0),e.k0s()()()}if(2&o){const i=e.sdS(27);e.R7$(8),e.Y8G("svgIcon","mat_solid:chevron_right"),e.R7$(4),e.Y8G("svgIcon","mat_solid:chevron_right"),e.R7$(8),e.Y8G("svgIcon","mat_solid:search"),e.R7$(),e.Y8G("formControl",s.searchInputControl)("autocomplete","off")("placeholder","Escriba para buscar..."),e.R7$(),e.Y8G("matMenuTriggerFor",i),e.R7$(),e.Y8G("svgIcon","mat_solid:expand_more"),e.R7$(3),e.Y8G("xPosition","before"),e.R7$(3),e.Y8G("svgIcon","mat_solid:description"),e.R7$(3),e.Y8G("svgIcon","mat_solid:description"),e.R7$(3),e.Y8G("svgIcon","mat_solid:add"),e.R7$(5),e.vxM(40,s.workshopServices.length>0?40:41)}},dependencies:[w.oe,I.Hl,I.$z,f.RG,f.rl,f.JW,W.m_,W.An,U.fS,U.fg,pe.Cn,pe.kk,pe.fb,pe.Cp,v.Ou,v.iy,J.D6,J.LG,O.mV,O.sG,S.NQ,S.B4,S.aE,w.YU,n.X1,n.me,n.BC,n.l_],encapsulation:2,changeDetection:0})}return r})();var Ur=p(47399),Xr=p(23301),Jr=p(99433),Qr=p(57981),qr=p(23285),Hr=p(59013),Kr=p(71411),Zr=p(90225),ve=p(99437),ke=p(18810);let es=(()=>{class r{constructor(t,o){this._vehicleInspectionsService=t,this._router=o}resolve(t,o){const s=t.paramMap.get("vehicleInspectionId");if("new"!==s)return this._vehicleInspectionsService.getVehicleInspectionById(s).pipe((0,ve.W)(i=>{console.error(i);const a=o.url.split("/").slice(0,-1).join("/");return this._router.navigateByUrl(a),(0,ke.$)(i)}))}static#e=this.\u0275fac=function(o){return new(o||r)(e.KVO(ue),e.KVO(A.Ix))};static#t=this.\u0275prov=e.jDH({token:r,factory:r.\u0275fac,providedIn:"root"})}return r})(),Te=(()=>{class r{constructor(t){this._vehicleInspectionsService=t}resolve(t,o){return this._vehicleInspectionsService.getVehicleInspections()}static#e=this.\u0275fac=function(o){return new(o||r)(e.KVO(ue))};static#t=this.\u0275prov=e.jDH({token:r,factory:r.\u0275fac,providedIn:"root"})}return r})(),ts=(()=>{class r{constructor(t,o){this._vehiclesService=t,this._router=o}resolve(t,o){const s=t.paramMap.get("vehicleId");if("new"!==s)return this._vehiclesService.getVehicleById(s).pipe((0,ve.W)(i=>{console.error(i);const a=o.url.split("/").slice(0,-1).join("/");return this._router.navigateByUrl(a),(0,ke.$)(i)}))}static#e=this.\u0275fac=function(o){return new(o||r)(e.KVO(me),e.KVO(A.Ix))};static#t=this.\u0275prov=e.jDH({token:r,factory:r.\u0275fac,providedIn:"root"})}return r})(),be=(()=>{class r{constructor(t){this._vehiclesService=t}resolve(t,o){return this._vehiclesService.getVehicles()}static#e=this.\u0275fac=function(o){return new(o||r)(e.KVO(me))};static#t=this.\u0275prov=e.jDH({token:r,factory:r.\u0275fac,providedIn:"root"})}return r})(),os=(()=>{class r{constructor(t){this._workshopOrdersService=t}resolve(t,o){return this._workshopOrdersService.getWorkshopOrders()}static#e=this.\u0275fac=function(o){return new(o||r)(e.KVO(de))};static#t=this.\u0275prov=e.jDH({token:r,factory:r.\u0275fac,providedIn:"root"})}return r})(),rs=(()=>{class r{constructor(t,o){this._workshopOrdersService=t,this._router=o}resolve(t,o){const s=t.paramMap.get("workshopOrderId");if("new"!==s)return this._workshopOrdersService.getWorkshopOrderById(s).pipe((0,ve.W)(i=>{console.error(i);const a=o.url.split("/").slice(0,-1).join("/");return this._router.navigateByUrl(a),(0,ke.$)(i)}))}static#e=this.\u0275fac=function(o){return new(o||r)(e.KVO(de),e.KVO(A.Ix))};static#t=this.\u0275prov=e.jDH({token:r,factory:r.\u0275fac,providedIn:"root"})}return r})(),Ge=(()=>{class r{constructor(t){this._workshopServicesService=t}resolve(t,o){return this._workshopServicesService.getWorkshopServices()}static#e=this.\u0275fac=function(o){return new(o||r)(e.KVO(ge))};static#t=this.\u0275prov=e.jDH({token:r,factory:r.\u0275fac,providedIn:"root"})}return r})(),Pe=(()=>{class r{constructor(t){this._workshopsService=t}resolve(t,o){return this._workshopsService.getWorkshops()}static#e=this.\u0275fac=function(o){return new(o||r)(e.KVO(fe))};static#t=this.\u0275prov=e.jDH({token:r,factory:r.\u0275fac,providedIn:"root"})}return r})();var Me=p(34413),ss=p(24121);const is=[{path:"",component:D},{path:"vehicles",component:Et,resolve:{vehicles:be}},{path:"vehicles/:vehicleId",component:Yt,resolve:{brands:Ur.T,fuels:Jr.w,vehicle:ts}},{path:"vehicles-inspections",component:ao,resolve:{vehicles:Te}},{path:"vehicles-inspections/:vehicleInspectionId",component:uo,resolve:{employees:Me.wf,vehicles:be,locations:ss.FH,inspection:es}},{path:"workshops",component:dt,resolve:{workshops:Pe}},{path:"workshop-orders",component:qo,resolve:{multiplier:Qr.d,operationTypes:qr.h,paymentMethods:Hr.v,rates:Kr.Q,workshopOrders:os}},{path:"workshop-orders/:workshopOrderId",component:hr,resolve:{employees:Me.wf,inspection:Te,serviceTypes:Zr.f,vehicles:be,workshopOrder:rs,workshops:Pe,workshopServices:Ge}},{path:"services",component:Yr,resolve:{currencies:Xr.p,workshopServices:Ge}}]}}]);