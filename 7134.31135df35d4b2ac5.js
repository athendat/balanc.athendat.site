"use strict";(self.webpackChunkfuse=self.webpackChunkfuse||[]).push([[7134],{29217:(v,y,r)=>{r.d(y,{OB:()=>c,x2:()=>s});var i=r(59640);const a=t=>t.employees,s=(0,i.Mz)(a,t=>t.employee),c=(0,i.Mz)(a,t=>t.employees)},62590:(v,y,r)=>{r.d(y,{r:()=>U});var i=r(96354),a=r(88141),s=r(98020),c=r(98216),t=r(73512);const I=t.J1`
...
`;let E=(()=>{class g{constructor(){this.apolloProvider=(0,i.WQX)(t.Ic),this.store=(0,i.WQX)(I.il),this._apollo=this.apolloProvider.use("BALANC")}createCurrency(e){return this.store.select(h.y$).pipe((0,a.s)(1),(0,s.n)(n=>this._apollo.mutate({mutation:$,variables:{createCurrencyInput:e},errorPolicy:"all"}).pipe((0,c.M)(({data:p})=>{const u=structuredClone(n);u.push(p.createCurrency.currency),this.store.dispatch((0,m.Ih)({currencies:u}))}))))}getCurrencies(e=1,n=20,p="name",u="asc",d=""){return this._apollo.query({query:C,variables:{offset:n*(e-1),limit:n,sort:p,order:u,search:d},errorPolicy:"all"}).pipe((0,c.M)(({data:o})=>{this.store.dispatch((0,f.Bp)({pagination:o.findAllCurrencies.pagination})),this.store.dispatch((0,m.Ih)({currencies:o.findAllCurrencies.currencies}))}))}getActiveCurrency(){return this._apollo.query({query:T,errorPolicy:"all"}).pipe((0,c.M)(({data:e})=>{e&&this.store.dispatch((0,m.Ih)({currencies:e.findAllActiveCurrencies.currencies}))}))}getCurrencyById(e){return this._apollo.query({query:U,variables:{findCurrencyByIdId:e},errorPolicy:"all"}).pipe((0,c.M)(({data:n})=>{this.store.dispatch((0,m.MN)({currency:n.findCurrencyById.currency}))}))}updateCurrency(e){return this.store.select(h.y$).pipe((0,a.s)(1),(0,s.n)(n=>this._apollo.mutate({mutation:A,variables:{updateCurrencyInput:e},errorPolicy:"all"}).pipe((0,c.M)(({data:p})=>{const u=structuredClone(n);u[n.findIndex(o=>o.id===e.id)]=p.updateCurrency.currency,this.store.dispatch((0,m.Ih)({currencies:u}))}))))}updateCurrencyStatus(e){return this.store.select(h.y$).pipe((0,a.s)(1),(0,s.n)(n=>this._apollo.mutate({mutation:M,variables:{updateEntityStatusInput:e},errorPolicy:"all"}).pipe((0,c.M)(({})=>{const u=structuredClone(n);u[n.findIndex(o=>o.id===e.id)].active=e.active,this.store.dispatch((0,m.Ih)({currencies:u}))}))))}removeCurrency(e){return this.store.select(h.y$).pipe((0,a.s)(1),(0,s.n)(n=>this._apollo.mutate({mutation:P,variables:{removeCurrencyId:e},errorPolicy:"all"}).pipe((0,c.M)(({})=>{const u=structuredClone(n),d=n.findIndex(o=>o.id===e);u.splice(d,1),this.store.dispatch((0,m.Ih)({currencies:u}))}))))}static#e=this.\u0275fac=function(n){return new(n||g)};static#t=this.\u0275prov=i.jDH({token:g,factory:g.\u0275fac,providedIn:"root"})}return g})()}}]);